...
/**
 * Recurs de manteniment de les claus privades SCSP.
 *
...
public class ClauPrivadaResource extends BaseResource<Long> {
    ...
    @NotNull
    private ResourceReference<OrganismeCessionariResource, Long> organisme;

    private boolean perEntitat;

    // Camp calculat (equivalent a ClauPrivada#isCaducada), no editable.
