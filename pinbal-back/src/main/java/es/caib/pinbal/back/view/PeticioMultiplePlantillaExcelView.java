 ...
 * @author Josep Gayà
 */
public class PeticioMultiplePlantillaExcelView extends AbstractHssfView implements MessageSourceAware {
	...
	private void taulaCamps(
		...
		capsaleraTitolStyle.setAlignment(HorizontalAlignment.LEFT);
		capsaleraTitolStyle.setVerticalAlignment(VerticalAlignment.CENTER);
		capsaleraTitolStyle.setBorderBottom(BorderStyle.MEDIUM);
		...
		capsaleraStyle.setBorderBottom(BorderStyle.THIN);
		capsaleraStyle.setBorderTop(BorderStyle.THIN);
		capsaleraStyle.setBorderLeft(BorderStyle.THIN);
		capsaleraStyle.setBorderRight(BorderStyle.THIN);
		...
		contingutTextStyle.setBorderBottom(BorderStyle.THIN);
		contingutTextStyle.setBorderTop(BorderStyle.THIN);
		contingutTextStyle.setBorderLeft(BorderStyle.THIN);
		contingutTextStyle.setBorderRight(BorderStyle.THIN);
