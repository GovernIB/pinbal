...
import es.caib.pinbal.back.validation.CodiServeiNoRepetit;
import es.caib.pinbal.back.validation.ServeiUrl;
...
public class ServeiCommand {
	...
	private Date scspFechaAlta = new Date();
	...
	private ServeiDto.JustificantTipusDto pinbalJustificantTipus;
