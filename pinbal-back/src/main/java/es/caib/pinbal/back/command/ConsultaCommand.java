...
import es.caib.pinbal.back.validation.ArxiuNoBuit;
import es.caib.pinbal.back.validation.DocumentIdentitatCif;
import es.caib.pinbal.back.validation.DocumentIdentitatDni;
import es.caib.pinbal.back.validation.DocumentIdentitatNie;
import es.caib.pinbal.back.validation.DocumentIdentitatNif;
import es.caib.pinbal.back.validation.DocumentIdentitatPass;
