...
public class ServeiController extends BaseController {
	...
	@GetMapping("/{serveiCodi}/downloadAjuda")
	...
	public String serveiCamp(
		...
		for (ServeiCampDto camp: camps) {
			if (camp.getTipus() == ServeiCampDto.ServeiCampDtoTipus.ENUM) {
	...
	@PostMapping("/{serveiCodi}/camp/add")
	...
	@PostMapping("/{serveiCodi}/camp/update")
	...
	@GetMapping("/{serveiCodi}/camp/{serveiCampId}/delete")
	...
	@PostMapping("/{serveiCodi}/camp/{serveiCampId}/move/{posicio}")
	@ResponseBody
	...
	@GetMapping("/{serveiCodi}/camp/{serveiCampId}/agrupar/{serveiCampGrupId}")
	...
	@PostMapping("/{serveiCodi}/camp/markResposta")
	@ResponseBody
	...
	@PostMapping("/{serveiCodi}/camp/unmarkResposta")
	@ResponseBody
	...
	@GetMapping("/{serveiCodi}/camp/{serveiCampId}/desagrupar")
	...
	@PostMapping("/{serveiCodi}/campGrup/add")
	...
	@PostMapping("/{serveiCodi}/campGrup/update")
	...
	@GetMapping("/{serveiCodi}/campGrup/{serveiCampGrupId}/delete")
	...
	@GetMapping("/{serveiCodi}/campGrup/{serveiCampGrupId}/up")
	...
	@GetMapping("/{serveiCodi}/campGrup/{serveiCampGrupId}/down")
	...
	@GetMapping("/{serveiCodi}/justificant")
	...
	@PostMapping("/{serveiCodi}/justificant")
	...
	@GetMapping("/{serveiCodi}/redir/new")
	...
	@GetMapping("/{codi}/xsd/{tipus}/download")
	...
	@PostMapping("/{serveiCodi}/xsd/save")
	@ResponseBody
	...
	@GetMapping("/{serveiCodi}/xsd/{serveiXsdId}")
	...
	@GetMapping("/{serveiCodi}/redir/{serveiBusId}")
	public String redirGet(
			HttpServletRequest request,
			@PathVariable String serveiCodi,
	...
	@GetMapping("/{serveiCodi}/regla/new")
	...
	@PostMapping("/{serveiCodi}/regla/new")
	...
	@GetMapping("/{serveiCodi}/regla/{reglaId}")
	...
	@PostMapping("/{serveiCodi}/regla/{reglaId}")
...
//		return "redirect:/servei/" + serveiCodi + "/camp";
	...
	@GetMapping("/{serveiCodi}/regla/{reglaId}/move/{posicio}")
	@ResponseBody
	...
	@GetMapping("/{serveiCodi}/regla/camp/select")
	@ResponseBody
	...
	@GetMapping("/{serveiCodi}/regla/grup/select")
	@ResponseBody
	...
	@PostMapping("/{serveiCodi}/redir/save")
	...
	@GetMapping("/{serveiCodi}/redir/{serveiBusId}/delete")
	public String delete(
			HttpServletRequest request,
			@PathVariable String serveiCodi,
	...
	@GetMapping("/{serveiCodi}/procediments")
