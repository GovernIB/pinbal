...
public class ProcedimentController extends BaseController {
	...
	@GetMapping("/{procedimentId}/clone")
	...
	@GetMapping("/{procedimentId}/delete")
	...
	@GetMapping("/{procedimentId}/enable")
	...
	@GetMapping("/{procedimentId}/disable")
	...
	@GetMapping(value = "/{procedimentId}/servei/datatable", produces="application/json")
	@ResponseBody
...
//		command.setActiu(true);
	...
	@GetMapping("/{procedimentId}/servei")
	...
	@PostMapping("/{procedimentId}/servei")
	...
	@GetMapping("/{procedimentId}/servei/new")
	...
	@PostMapping("/{procedimentId}/servei/save")
	public String procedimentServeiSave(
			HttpServletRequest request,
			@PathVariable Long procedimentId,			
			@Valid ProcedimentServeiCommand command,
			BindingResult bindingResult,
		...
		if (entitat != null) {
			...
			if (procedimentId != null)
				procediment = procedimentService.findById(procedimentId);
			if (procediment != null) {
				procedimentService.serveiEnable(procedimentId, command.getServeiCodi());
				ServeiDto servei = serveiService.findAmbCodiPerAdminORepresentant(command.getServeiCodi());
	...
	@GetMapping(value = "/serveis/{text}", produces="application/json")
	@ResponseBody
	...
	@GetMapping("/{procedimentId}/servei/{serveiCodi}/enable")
	...
	@GetMapping("/{procedimentId}/servei/{serveiCodi}/disable")
		...
		if (entitat != null) {
			...
			if (procediment != null) {
				...
				AlertHelper.success(
						...
						getMessage(
								request,
								"procediment.controller.servei.esborrat",
								new Object[] {servei.getDescripcio()}));
				return "redirect:../../servei";
			} else {
				AlertHelper.error(
	...
	@GetMapping("/{procedimentId}/servei/{serveiCodi}/permis")
	...
	@PostMapping("/{procedimentId}/servei/{serveiCodi}/permis")
	...
	@GetMapping(value = "/{procedimentId}/servei/{serveiCodi}/permis/datatable", produces="application/json")
	@ResponseBody
...
//		return new ServerSideResponse<EntitatUsuariDto, Long>(serverSideRequest, page);
	...
	@GetMapping("/{procedimentId}/servei/{serveiCodi}/permis/{usuariCodi}/allow")
	...
	@GetMapping("/{procedimentId}/servei/{serveiCodi}/permis/{usuariCodi}/deny")
	...
	@GetMapping("/{procedimentId}/servei/{serveiCodi}/permis/new")
	public String serveiPermisPost(
			HttpServletRequest request,
			@PathVariable Long procedimentId,
			@PathVariable String serveiCodi,
	...
	@PostMapping("/{procedimentId}/servei/{serveiCodi}/permis/save")
	...
	@ResponseBody
	@GetMapping("/{procedimentId}/servei/{serveiCodi}/procedimentCodi")
    ...
    @GetMapping("/{procedimentId}/servei/{serveiCodi}/migrar")
...
//        List<ServeiDto> serveis = serveiService.findAmbEntitatNotInProcediment(entitat.getId(), procedimentId);
    ...
    @PostMapping("/{procedimentId}/servei/{serveiCodi}/migrar")
