<%@ page import="es.caib.pinbal.back.controller.SuperauditorController" %>
...
<body>
	...
	<c:if test="${not empty entitatActual}">
		...
		<div class="pull-right">		
			<a class="btn btn-default" href="superauditor/excel"><i class="far fa-file-excel"></i>&nbsp;<spring:message code="estadistiques.list.exportar.excel"/></a>	
		</div>
...
<script id="template-details" type="x-tmpl-mustache">
	<a href="superauditor/{{ id }}" class="btn btn-default" data-toggle="modal"><i class="fas fa-search-plus"></i>&nbsp;<spring:message code="admin.consulta.list.taula.detalls"/></a>
</script>
	</c:if>
</body>
</html>
