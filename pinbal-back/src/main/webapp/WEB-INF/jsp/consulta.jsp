<%@ page import="es.caib.pinbal.back.controller.ConsultaController" %>
...
<%	request.setAttribute("consultaEstats", es.caib.pinbal.logic.intf.dto.ConsultaDto.EstatTipus.sortedValues());
	request.setAttribute("historicSession", ConsultaController.SESSION_CONSULTA_HISTORIC);
%>
<html>
<head>
	...
	<table id="table-consultes" class="table table-striped table-bordered" style="width: 100%">
		<thead>
			<tr>
				...
				<th data-data="procedimentCodiNom"><spring:message code="consulta.list.taula.procediment" /></th><%-- 2 --%>
				<th data-data="serveiCodiNom"><spring:message code="consulta.list.taula.servei" /></th><%-- 3 --%>
