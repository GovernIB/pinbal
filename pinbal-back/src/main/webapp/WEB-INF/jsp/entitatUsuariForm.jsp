...
<%
	...
	pageContext.setAttribute("isRolActualSuperauditor", RolHelper.isRolActualSuperauditor(request));
%>
...
<body>
	...
	<c:url value="/modal/entitat/${entitatUsuariCommand.id}/usuari/save" var="formAction"/>
...
<%--		<pbl:inputText name="codi" textKey="representant.usuaris.filtre.camp.codi" labelSize="2" readonly="true"/>--%>
		...
		<div class="form-group">
			<div class="col-md-10 col-md-offset-2" style="margin-top: 0px; padding-left: 35px;">
				<label class="checkbox" for="actiu">
					<form:checkbox path="actiu" id="actiu" name="actiu" />
		...
		<div class="form-group">
			...
			<div class="col-md-10" style="margin-top: 0px; padding-left: 35px;">
				<label class="checkbox" for="rolRepresentant">
					<form:checkbox path="rolRepresentant" id="rolRepresentant" name="rolRepresentant" />
					<spring:message code="representant.usuaris.rol.repres"/>
				</label>
				<label class="checkbox" for="rolDelegat">
					<form:checkbox path="rolDelegat" id="rolDelegat" name="rolDelegat" />
				...
				<label class="checkbox" for="rolAplicacio">
					<form:checkbox path="rolAplicacio" id="rolAplicacio" name="rolAplicacio" />
