...
/**
 * Aplicacio Spring Boot de l'API interna de PINBAL.
 *
...
public class PinbalApiInternaApp extends SpringBootServletInitializer {

	@Override
	protected SpringApplicationBuilder configure(SpringApplicationBuilder builder) {
		return builder.sources(PinbalApiInternaApp.class);
	}

	public static void main(String[] args) {
		SpringApplication.run(PinbalApiInternaApp.class, args);
	}
