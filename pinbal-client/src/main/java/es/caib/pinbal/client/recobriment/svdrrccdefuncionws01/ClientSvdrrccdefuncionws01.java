 ...
 * 
 */
package es.caib.pinbal.client.recobriment.svdrrccdefuncionws01;
...
/**
 * Client del recobriment per a fer peticions al servei SCSP SVDRRCCDEFUNCIONWS01:
 * "Consulta de defunción"
 * 
 * @author Limit Tecnologies <limit@limit.es>
 */
public class ClientSvdrrccdefuncionws01 extends ClientBase {

	private static final String SERVEI_CODI = "SVDRRCCDEFUNCIONWS01";

	public ClientSvdrrccdefuncionws01(
			String urlBase,
			String usuari,
			String contrasenya) {
	...
	public ScspRespuesta peticionSincrona(
			List<SolicitudSvdrrccdefuncionws01> solicituds) throws IOException {
	...
	public static class SolicitudSvdrrccdefuncionws01 extends SolicitudBaseSvdrrcc {
