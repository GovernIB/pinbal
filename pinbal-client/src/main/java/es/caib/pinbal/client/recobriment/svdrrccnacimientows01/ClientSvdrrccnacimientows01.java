 ...
 * 
 */
package es.caib.pinbal.client.recobriment.svdrrccnacimientows01;
...
/**
 * Client del recobriment per a fer peticions al servei SCSP SVDRRCCNACIMIENTOWS01:
 * "Consulta de Nacimiento"
 * 
 * @author Limit Tecnologies <limit@limit.es>
 */
public class ClientSvdrrccnacimientows01 extends ClientBase {

	private static final String SERVEI_CODI = "SVDRRCCNACIMIENTOWS01";

	public ClientSvdrrccnacimientows01(
			String urlBase,
			String usuari,
			String contrasenya) {
	...
	public ScspRespuesta peticionSincrona(
			List<SolicitudSvdrrccnacimientows01> solicituds) throws IOException {
	...
	public static class SolicitudSvdrrccnacimientows01 extends SolicitudBaseSvdrrcc {
