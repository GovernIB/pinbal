...
import es.caib.pinbal.client.recobriment.svdsccnws01.ClientSvdsccnws01;
import es.caib.pinbal.client.recobriment.svdsccnws01.ClientSvdsccnws01.SolicitudSvdsccnws01;
...
public class Svdsccnws01Test {
	...
	private ClientSvdsccnws01 client = new ClientSvdsccnws01(URL_BASE, USUARI, CONTRASENYA, BASIC_AUTH, null, null);

	@Test
	public void peticionSincrona() throws UniformInterfaceException, ClientHandlerException, IOException {
		SolicitudSvdsccnws01 solicitud = new SolicitudSvdsccnws01();
		...
		solicitud.setIdExpediente("testPinbal/996");
