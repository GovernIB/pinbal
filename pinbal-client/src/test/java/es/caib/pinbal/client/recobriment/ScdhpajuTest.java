...
public class ScdhpajuTest {
	...
	private static final String PETICION_SCSP_ID = "PINPRE00000000000000001767";
	private static final boolean ENABLE_LOGGING = true;
	private static final boolean BASIC_AUTH = true;

	private ClientScdhpaju client = new ClientScdhpaju(URL_BASE, USUARI, CONTRASENYA, BASIC_AUTH, null, null);
	...
	public void peticionSincrona() throws UniformInterfaceException, ClientHandlerException, IOException {
		...
		solicitud.setIdExpediente("testPinbal/888");
