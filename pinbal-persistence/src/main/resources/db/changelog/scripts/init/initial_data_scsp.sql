...
INSERT INTO core_parametro_configuracion(nombre, valor, descripcion) VALUES ('nombre.ministerio','Ministerio de Asuntos Económicos y Transformación Digital','Nombre del Ministerio');
...
INSERT INTO core_parametro_configuracion(nombre, valor, descripcion) VALUES ('version.datamodel.scsp','5.11.0','Especifica la versión del modelo de datos actual');

INSERT INTO core_parametro_configuracion(nombre, valor, descripcion) VALUES ('axis2.client.repository','/axis2/',null);
INSERT INTO core_parametro_configuracion(nombre, valor, descripcion) VALUES ('axis2.client.xml','/axis2/axis2.xml',null);
INSERT INTO core_parametro_configuracion(nombre, valor, descripcion) VALUES ('polling.enabled','true',null);
INSERT INTO core_parametro_configuracion(nombre, valor, descripcion) VALUES ('task.polling.espera','1',null);
INSERT INTO core_parametro_configuracion(nombre, valor, descripcion) VALUES ('task.polling.intervalo','5',null);
INSERT INTO core_parametro_configuracion(nombre, valor, descripcion) VALUES ('validacion.formatoFirma','permisivo',null);
