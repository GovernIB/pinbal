...
public class IdGenerator {
    ...
    public String getIdPeticion(Servicio servicio)
        ...
        // Per evitar error si s'ha guardat una petició a la taula de peticion_respuesta, però degut a un rollback
        do {
            ...
            idPeticion = prefix + secuencial;
        } while (peticionRespuestaDao.select(idPeticion) != null);
