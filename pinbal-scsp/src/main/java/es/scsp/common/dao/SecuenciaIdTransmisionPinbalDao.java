 ...
 */
@Component("secuenciaIdTransmisionDao")
public class SecuenciaIdTransmisionPinbalDao extends SecuenciaIdTransmisionDao implements ApplicationContextAware {
	...
	public String next(String prefijo) throws ScspException {
		...
		String result = "";
		try {
			cs = conn.prepareCall("{ call GETSECUENCIAIDTRANSMISION(?,?)}");
