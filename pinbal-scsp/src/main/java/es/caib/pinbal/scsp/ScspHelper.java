...
public class ScspHelper implements ApplicationContextAware, MessageSourceAware {
	...
	private boolean staticContextConfigurat = false;
	private void configureStaticContextSupport() {
		if (!staticContextConfigurat) {
			StaticContextSupport.setContextInstance(applicationContext);
			staticContextConfigurat = true;
		}
	}
