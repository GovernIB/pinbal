						...
						<fo:block margin-top="10pt" margin-left="2pt" margin-right="2pt" text-indent="3mm" font-family="Arial,sans-serif" font-size="10pt" space-before="5mm" space-after="4mm">
								...
								<fo:table-body start-indent="0pt">
									...
									<fo:table-row>
										...
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt" font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-style="normal">
													<xsl:value-of select="$actividades/*[local-name()='NumeroRegistrosExistentes']"/>
												</fo:inline>
											</fo:block>
										</fo:table-cell>
										<fo:table-cell padding="2pt" display-align="center">
										...
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt" font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-style="normal">
													<xsl:value-of select="$actividades/*[local-name()='NumeroRegistrosFacilitados']"/>
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
							...
							<fo:block margin-top="10pt" margin-left="2pt" margin-right="2pt" text-indent="3mm" font-family="Arial,sans-serif" font-size="10pt" space-before="5mm" space-after="4mm">
								...
								<fo:table table-layout="fixed" width="100%" border-spacing="5pt" space-after="2mm">
									...
									<fo:table-body start-indent="0pt">
										<!-- Fila  Hijo -->
										<xsl:for-each select="$actividades/*[local-name()='DatosActividad']"> 
											<fo:table-row>
												...
												<fo:table-cell padding="2pt" display-align="center">
													<fo:block text-align="left" margin="0pt">
														<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
															<fo:inline font-style="normal">
																<xsl:value-of select="./*[local-name()='DescripcionEpigrafe']"/>
															</fo:inline>
														</fo:block>
													</fo:block>
												</fo:table-cell>
														...
														<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
															<fo:inline font-style="normal">
																<xsl:if test="./*[local-name()='FechaInicio'] != ''"> 
															 		<xsl:value-of select="concat(substring(string(./*[local-name()='FechaInicio']),7,2),'/',substring(string(./*[local-name()='FechaInicio']),5,2),'/',substring(string(./*[local-name()='FechaInicio']),1,4))"/>
															   </xsl:if>
															</fo:inline>
														</fo:block>
													</fo:block>
														...
														<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
															<fo:inline font-style="normal">
																<xsl:if test="./*[local-name()='FechaFin'] != ''"> 
																	<xsl:if test="*[local-name()='FechaFin'] != '0'"> 
																		<xsl:value-of select="concat(substring(string(./*[local-name()='FechaFin']),7,2),'/',substring(string(./*[local-name()='FechaFin']),5,2),'/',substring(string(./*[local-name()='FechaFin']),1,4))"/>
																	</xsl:if>
																</xsl:if>
															</fo:inline>
														</fo:block>
