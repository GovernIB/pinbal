										...
										<fo:table-row>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal"> 
														 <xsl:if test="*[local-name()='Retribucion']">
															<xsl:value-of select="*[local-name()='Retribucion'] div 100"/>
														</xsl:if>
														</fo:inline>
													</fo:block>
												</fo:block>
										...
										<fo:table-row>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
														<xsl:if test="*[local-name()='Retencion']">
															<xsl:value-of select="*[local-name()='Retencion'] div 100"/>
														</xsl:if>
														</fo:inline>
													</fo:block>
												</fo:block>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
														 <xsl:if test="*[local-name()='Valoracion']">
															<xsl:value-of select="*[local-name()='Valoracion'] div 100"/>
														</xsl:if>
														</fo:inline>
													</fo:block>
												</fo:block>
										...
										<fo:table-row>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															 <xsl:if test="*[local-name()='IngresosACuenta']">
															<xsl:value-of select="*[local-name()='IngresosACuenta'] div 100"/>
															</xsl:if>
														</fo:inline>
													</fo:block>
												</fo:block>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal"> 
														 <xsl:if test="*[local-name()='IngresosACuentaReperc']">
															<xsl:value-of select="*[local-name()='IngresosACuentaReperc'] div 100"/>
															</xsl:if>
														</fo:inline>
													</fo:block>
												</fo:block>
