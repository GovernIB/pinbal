...
contains($spacechars, $c2))">
	...
	<xsl:template match="/">
		<xsl:variable name="datosEspecificos" select="//*[local-name()='Respuesta']/*[local-name()='Transmisiones']/*[local-name()='TransmisionDatos']/*[local-name()='DatosEspecificos']"/>
		<xsl:variable name="datosTitular" select="//*[local-name()='Respuesta']/*[local-name()='Transmisiones']/*[local-name()='TransmisionDatos']/*[local-name()='DatosGenericos']/*[local-name()='Titular']"/>
		<fo:root>
	...
	<xsl:template match="//*[local-name()='DatosEspecificos']">
		...
		<xsl:variable name="datosRendimientos" select="$datosEspecificos/*[local-name()='Rendimientos']"/>
		<xsl:variable name="listaRendimientos" select="$datosRendimientos/*[local-name()='Rendimiento']"/>
		...
		<xsl:choose>
			...
			<xsl:when test="$datosCabecera/*[local-name()='CodigoRet'] != '1000' ">
			...
			<xsl:when test="$datosCabecera/*[local-name()='CodRet'] = '1000'">
				<fo:block text-align="left" margin-top="25pt">
					<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
						<fo:inline font-weight="bold">
				...
				<fo:block border-style="solid" border-width="1px 1px 1px 1px">
					...
					<xsl:if test="$datosCabecera">
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row>
										<fo:table-cell padding="3pt" display-align="center" background-color="#B0C4DE">
											<fo:block>
												<fo:inline font-weight="bold" display-align="after">
													<xsl:text>Datos Cabecera</xsl:text>
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<fo:block margin-top="10pt" margin-left="2pt" margin-right="2pt" text-indent="3mm" font-family="Arial,sans-serif" font-size="10pt" space-after="4mm">
							...
							<fo:table table-layout="fixed" width="100%" border-spacing="5pt" space-after="2mm">
								...
								<fo:table-column column-width="proportional-column-width(1.88)"/>
								<fo:table-column column-width="proportional-column-width(2.14)"/>
								<fo:table-body start-indent="0pt">
									...
									<fo:table-row>
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-weight="bold">
														<xsl:text>Descripción Respuesta:</xsl:text>
														<fo:leader leader-pattern="space"/>
													</fo:inline>
												</fo:block>
											</fo:block>
										...
										<xsl:if test="$datosCabecera/*[local-name()='TipoRespuesta']">
											<fo:table-cell padding="2pt" display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-weight="bold">
					...
					<xsl:if test="$datosRendimientos">
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row>
										<fo:table-cell padding="3pt" display-align="center" background-color="#B0C4DE">
											<fo:block>
												<fo:inline font-weight="bold" display-align="after">
													<xsl:text>Rendimientos del ejercicio </xsl:text>
													<xsl:value-of select="$datosRendimientos/*[local-name()='Ejercicio']"/>
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:for-each select="$datosRendimientos/*[local-name()='Rendimiento']">
							...
							<fo:block margin-top="10pt" margin-left="2pt" margin-right="2pt" text-indent="3mm" font-family="Arial,sans-serif" font-size="10pt" space-before="5mm" space-after="4mm">
								...
								<!-- Inicio pintar Rendimiento -->
								<fo:table table-layout="fixed" width="100%" space-after="0mm">
									<!--<fo:table-column column-width="proportional-column-width(0.7)"/>
									<fo:table-column column-width="proportional-column-width(0.5)"/>
									...
									<fo:table-body start-indent="0pt">
										<fo:table-row>
											<fo:table-cell display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Referencia:</xsl:text>
														</fo:inline>
													</fo:block>
											...
											<fo:table-cell display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:value-of select="./*[local-name()='ReferenciaRdto']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
										...
										<fo:table-row>
											<fo:table-cell display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>NIF Retenedor:</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:value-of select="./*[local-name()='NifRetenedor']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
										...
										<fo:table-row>
											<fo:table-cell display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Nombre Retenedor: </xsl:text>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:value-of select="./*[local-name()='NombreRetenedor']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
										...
										<fo:table-row>
											...
											<fo:table-cell display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:value-of select="./*[local-name()='DescripcionClave']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
										...
										<fo:table-row>
											...
											<fo:table-cell display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:value-of select="./*[local-name()='DescripcionSubclave']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
										...
										<fo:table-row>
											<fo:table-cell display-align="center">
												<fo:block>
													<fo:inline font-weight="bold" display-align="after" font-size="8pt" font-family="Arial,Helvetica,sans-serif">
											...
											<fo:table-cell display-align="center">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" display-align="after">
													<xsl:variable name="retribucion" select="./*[local-name()='Retribucion']"/>
													<xsl:choose>
														<xsl:when test="$retribucion">
															<fo:inline font-style="normal">
																<xsl:if test="string($retribucion/*[local-name()='Signo']) != ''">
																	<xsl:value-of select="$retribucion/*[local-name()='Signo']"/>
																</xsl:if>
																<xsl:value-of select="$retribucion/*[local-name()='Enteros']"/>
																<xsl:if test="string($retribucion/*[local-name()='Decimales']) != ''">
																	<xsl:text>,</xsl:text>
																	<xsl:value-of select="$retribucion/*[local-name()='Decimales']"/>
																</xsl:if>
															</fo:inline>
														</xsl:when>														
													</xsl:choose>
										...
										<fo:table-row>
											...
											<fo:table-cell display-align="center">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" display-align="after">
													<xsl:variable name="retencion" select="./*[local-name()='Retencion']"/>
													<xsl:choose>
														<xsl:when test="$retencion">
															<fo:inline font-style="normal">
																<xsl:if test="string($retencion/*[local-name()='Signo']) != ''">
																	<xsl:value-of select="$retencion/*[local-name()='Signo']"/>
																</xsl:if>
																<xsl:value-of select="$retencion/*[local-name()='Enteros']"/>
																<xsl:if test="string($retencion/*[local-name()='Decimales']) != ''">
																	<xsl:text>,</xsl:text>
																	<xsl:value-of select="$retencion/*[local-name()='Decimales']"/>
																</xsl:if>
															</fo:inline>
														</xsl:when>
													</xsl:choose>
										...
										<fo:table-row>
											...
											<fo:table-cell display-align="center">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" display-align="after">
													<xsl:variable name="valoracion" select="./*[local-name()='Valoracion']"/>
													<xsl:choose>
														<xsl:when test="$valoracion">
															<fo:inline font-style="normal">
																<xsl:if test="string($valoracion/*[local-name()='Signo']) != ''">
																	<xsl:value-of select="$valoracion/*[local-name()='Signo']"/>
																</xsl:if>
																<xsl:value-of select="$valoracion/*[local-name()='Enteros']"/>
																<xsl:if test="string($valoracion/*[local-name()='Decimales']) != ''">
																	<xsl:text>,</xsl:text>
																	<xsl:value-of select="$valoracion/*[local-name()='Decimales']"/>
																</xsl:if>
															</fo:inline>
														</xsl:when>
													</xsl:choose>
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell display-align="center">
													<fo:block>
														<fo:inline font-weight="bold" display-align="after" font-size="8pt" font-family="Arial,Helvetica,sans-serif">
															<xsl:text>Ingresos a Cuenta Efectuados:  </xsl:text>
														</fo:inline>
														<xsl:variable name="ingresosAcuenta" select="./*[local-name()='IngresosACuenta']"/>
														<xsl:choose>
															<xsl:when test="$ingresosAcuenta">
																<fo:inline font-style="normal">
																	<xsl:if test="string($ingresosAcuenta/*[local-name()='Signo']) != ''">
																		<xsl:value-of select="$ingresosAcuenta/*[local-name()='Signo']"/>
																	</xsl:if>
																	<xsl:value-of select="$ingresosAcuenta/*[local-name()='Enteros']"/>
																	<xsl:if test="string($ingresosAcuenta/*[local-name()='Decimales']) != ''">
																		<xsl:text>,</xsl:text>
																		<xsl:value-of select="$ingresosAcuenta/*[local-name()='Decimales']"/>
																	</xsl:if>
																</fo:inline>
															</xsl:when>														
														</xsl:choose>
											...
											<fo:table-row>
												<fo:table-cell display-align="center">
													<fo:block>
														<fo:inline font-weight="bold" display-align="after" font-size="8pt" font-family="Arial,Helvetica,sans-serif">
															<xsl:text>Ingresos a Cuenta Repercutidos:  </xsl:text>
														</fo:inline>
														<xsl:variable name="ingresosAcuentaRepercutidos" select="./*[local-name()='IngresosACuentaReperc']"/>
														<xsl:choose>
															<xsl:when test="$ingresosAcuentaRepercutidos">
																<fo:inline font-style="normal">
																	<xsl:if test="string($ingresosAcuentaRepercutidos/*[local-name()='Signo']) != ''">
																		<xsl:value-of select="$ingresosAcuentaRepercutidos/*[local-name()='Signo']"/>
																	</xsl:if>
																	<xsl:value-of select="$ingresosAcuentaRepercutidos/*[local-name()='Enteros']"/>
																	<xsl:if test="string($ingresosAcuentaRepercutidos/*[local-name()='Decimales']) != ''">
																		<xsl:text>,</xsl:text>
																		<xsl:value-of select="$ingresosAcuentaRepercutidos/*[local-name()='Decimales']"/>
																	</xsl:if>
																</fo:inline>
															</xsl:when>														
														</xsl:choose>
