...
<xsl:output version="1.0" method="xml" encoding="UTF-8" indent="no"/>
		...
		<fo:root>
			<fo:layout-master-set>
				<fo:simple-page-master master-name="default-page"
					...
					<fo:region-body margin-top="82" margin-bottom="120"
						margin-left="0.2in" />
	...
	<xsl:template match="//*[local-name()='DatosEspecificos']">
		...
		<xsl:choose>
			...
			<xsl:when test="$datosEspecificos/*[local-name()='Estado']/*[local-name()='CodigoEstado'] != '0000' and $datosEspecificos/*[local-name()='Estado']/*[local-name()='CodigoEstado'] != '0001'">
				<fo:block margin-top="40pt" text-align="center" font-family="Arial,sans-serif" font-size="10pt" line-height="10pt" space-after.optimum="1pt" display-align="after">
					<fo:inline font-weight="bold">
						...
						<xsl:value-of select="$datosEspecificos/*[local-name()='Estado']/*[local-name()='CodigoEstado']"/>
						<xsl:text>  -  </xsl:text>
						<xsl:value-of select="$datosEspecificos/*[local-name()='Estado']/*[local-name()='LiteralError']"/>
					</fo:inline>
				</fo:block>
			</xsl:when>
			
			<xsl:when test="$datosEspecificos/*[local-name()='Estado']/*[local-name()='CodigoEstado'] = '0000' or $datosEspecificos/*[local-name()='Estado']/*[local-name()='CodigoEstado'] = '0001'">
			<fo:block text-align="left" margin-top="25pt">
					<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
						<fo:inline font-weight="bold">
				...
				<fo:block border-style="solid" border-width="1px 1px 1px 1px">
					<fo:block text-indent="3mm" margin-top="2pt" margin-left="2pt"
						...
						space-before="1mm" space-after="4mm">
						<!-- Panel Datos titular -->
						...
						<fo:block text-indent="3mm" margin-top="2pt"
							margin-left="2pt" margin-right="2pt" font-family="Arial,sans-serif"
							font-size="10pt" space-before="1mm" space-after="4mm">
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row>
										<fo:table-cell padding="3pt" display-align="center"
											...
											<fo:block>
												<fo:inline font-weight="bold" display-align="after">
													<xsl:text>Datos de consulta de dependencia</xsl:text>
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<fo:table table-layout="fixed" border-spacing="5pt"
							space-before="2mm">
							<fo:table-column column-width="proportional-column-width(1)" />
							<fo:table-column column-width="proportional-column-width(1)" />
							<fo:table-column column-width="proportional-column-width(1)" />
									...
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
												...
												<fo:inline font-style="normal">
													<xsl:value-of
														select="$datosEspecificos/*[local-name()='Resolucion']/*[local-name()='NumeroExpediente']" />
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
												line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="bold">
													<xsl:text>Grado y nivel:</xsl:text>
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
												...
												<fo:inline font-style="normal">
													<xsl:value-of
														select="$datosEspecificos/*[local-name()='Resolucion']/*[local-name()='GradoyNivel']" />
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
									...
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
												line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="bold">
													<xsl:text>Fecha de resolución:</xsl:text>
													<!-- fo:leader leader-pattern="space" / -->
												</fo:inline>
											</fo:block>
										</fo:block>
									...
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
												...
												<fo:inline font-style="normal">
													<xsl:value-of
														select="$datosEspecificos/*[local-name()='Resolucion']/*[local-name()='FechaResolucion']" />
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
												line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="bold">
													<xsl:text>Estado resolución: </xsl:text>
													<!-- fo:leader leader-pattern="space" / -->
												</fo:inline>
											</fo:block>
										</fo:block>
									...
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
												line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-style="normal">
													<xsl:value-of 	select="$datosEspecificos/*[local-name()='Resolucion']/*[local-name()='EstadoResolucion']" />
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
									...
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
												...
												<fo:inline font-style="normal">
													<xsl:value-of
														select="$datosEspecificos/*[local-name()='Resolucion']/*[local-name()='Tipo']" />
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
