...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="2.0"  xmlns:xs="http://www.w3.org/2001/XMLSchema" >
	...
	<xsl:param name="ConsultaFechaDesde"/>
	<xsl:param name="ConsultaFechaHasta"/>
    
    
	<xsl:template match="/">
		<xsl:variable name="datosEspecificos" select="//*[local-name()='DatosEspecificos']/*[local-name()='Salida']"/> 
		<fo:root>
	...
	<xsl:template match="//*[local-name()='DatosEspecificos']">
		<xsl:variable name="datosEspecificos" select="//*[local-name()='TransmisionDatos']/*[local-name()='DatosEspecificos']/*[local-name()='Salida']"/>
	...
	<!-- DATOS DE LA CONSULTA  -->
				...
				<fo:table-body start-indent="0pt">
					...
					<fo:table-row>  
						<fo:table-cell padding="2pt" display-align="center" >							
								<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
									<fo:inline font-weight="bold">
										<xsl:if test="$ConsultaFechaDesde != ''">
						...
						<fo:table-cell padding="2pt" display-align="center"  >						
								<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
									<xsl:if test="$ConsultaFechaDesde != ''">
										<xsl:value-of select="concat(substring(string($ConsultaFechaDesde),9,2),'/',substring(string($ConsultaFechaDesde),6,2),'/',substring(string($ConsultaFechaDesde),1,4))"/>				
									</xsl:if>
								</fo:block>							
						</fo:table-cell>	
						<fo:table-cell padding="2pt" display-align="center" >							
								<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
									<fo:inline font-weight="bold">
										<xsl:if test="$ConsultaFechaHasta != ''">
						...
						<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="3" >						
								<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" > 
									<xsl:if test="$ConsultaFechaHasta != ''">
										<xsl:value-of select="concat(substring(string($ConsultaFechaHasta),9,2),'/',substring(string($ConsultaFechaHasta),6,2),'/',substring(string($ConsultaFechaHasta),1,4))"/>					
									</xsl:if>
								</fo:block>							
						</fo:table-cell>					
					</fo:table-row>		
		...
		<xsl:choose>  
			<xsl:when test="$estado/*[local-name()='CodigoEstado'] != '0000'">
				<xsl:variable name="estado" select="$datosEspecificos/*[local-name()='Estado']"/>
				...
				<fo:block border-style="solid" border-width="1px 1px 1px 1px">
										...
										<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="2">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-style="normal">
														<xsl:choose>
															<xsl:when test="$datosTitular/*[local-name()='NombreCompleto'] = ''">
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row>
										<fo:table-cell padding="3pt" display-align="center" background-color="#B0C4DE">
											<fo:block>
												<fo:inline font-weight="bold" display-align="after">
													<xsl:text>Datos prestaciones</xsl:text>
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
					...
					<fo:block margin-top="10pt" margin-left="2pt" margin-right="2pt" text-indent="3mm" font-family="Arial,sans-serif" font-size="10pt" space-before="5mm" space-after="4mm">
							<fo:table table-layout="fixed" width="100%" border-spacing="5pt" space-after="2mm">
								...
								<fo:table-column column-width="proportional-column-width(1)"/>  
								<fo:table-body start-indent="0pt"> 
									<xsl:if test="$datosEspecificos/*[local-name()='FechaConsulta'] !=''">
										<fo:table-row>
											<fo:table-cell padding="2pt" display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
											...
											<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="3">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:if test="$datosEspecificos/*[local-name()='FechaConsulta'] !=''">
																<xsl:value-of select="concat(substring(string($datosEspecificos/*[local-name()='FechaConsulta']),9,2),'/',substring(string($datosEspecificos/*[local-name()='FechaConsulta']),6,2),'/',substring(string($datosEspecificos/*[local-name()='FechaConsulta']),1,4))"/>
															</xsl:if>
														</fo:inline>
													</fo:block>
												</fo:block>
									 ...
									 <xsl:if test="$datosEspecificos/*[local-name()='DocumentoIdentificativoUnivoco'] !=''">
										<fo:table-row>
											<fo:table-cell padding="2pt" display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Documento unívoco:</xsl:text>
															<fo:leader leader-pattern="space"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											...
											<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="3">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:choose>
																<xsl:when test="$datosEspecificos/*[local-name()='DocumentoIdentificativoUnivoco']= 'S'">
																	<xsl:text>Unívoco</xsl:text>
																</xsl:when>
																<xsl:when test="$datosEspecificos/*[local-name()='DocumentoIdentificativoUnivoco']= 'N'">
																	<xsl:text>Duplicado</xsl:text>
																</xsl:when>
															</xsl:choose> 
														</fo:inline>
													</fo:block>
									...
									<xsl:if test="$datosEspecificos/*[local-name()='NumeroPrestacionesEncontradas'] !=''">
										<fo:table-row>
											<fo:table-cell padding="2pt" display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Nº Prestaciones:</xsl:text>
															<fo:leader leader-pattern="space"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											...
											<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="3">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:value-of select="$datosEspecificos/*[local-name()='NumeroPrestacionesEncontradas']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell> 
					...
					<xsl:variable name="prestaciones" select="$datosEspecificos/*[local-name()='prestaciones']"/> 
					<xsl:if test="$prestaciones">
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row>
										<fo:table-cell padding="3pt" display-align="center" background-color="#B0C4DE">
											<fo:block>
												<fo:inline font-weight="bold" display-align="after">
													<xsl:text>Prestaciones</xsl:text>
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:for-each select="$prestaciones/*[local-name()='Prestacion']"> 
 							<xsl:variable name="prestacionCount" select="position()"/>
							<fo:block margin-top="10pt" margin-left="2pt" margin-right="2pt" text-indent="3mm" font-family="Arial,sans-serif" font-size="10pt" space-before="5mm" space-after="4mm">
											...
											<fo:table-cell padding="1pt" display-align="center" background-color="#B0C4DE">
												<fo:block>
													<fo:inline font-weight="bold" display-align="after" font-size="9pt" font-family="Arial,Helvetica,sans-serif">
														<xsl:text>Prestación </xsl:text>
														 <xsl:value-of select="$prestacionCount" />
													</fo:inline>
												</fo:block>
											</fo:table-cell>
										</fo:table-row>
											...
											<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="3">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:text>(</xsl:text>
															<xsl:value-of select="./*[local-name()='CodigoPrestacion']"/>
															<xsl:text>) </xsl:text>
															<xsl:value-of select="./*[local-name()='LiteralPrestacion']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="3">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:choose>
																<xsl:when test="./*[local-name()='TipoPrestacion'] = 'SI'">
																	<xsl:text>Contributiva</xsl:text>
																</xsl:when>
																<xsl:when test="./*[local-name()='TipoPrestacion'] ='NO' ">
																	<xsl:text>No contributiva</xsl:text>
																</xsl:when>
																<xsl:otherwise>
																	<xsl:text>Se desconoce</xsl:text>
																</xsl:otherwise>
															</xsl:choose>	 
														</fo:inline>
													</fo:block>
											...
											<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="3">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:text>(</xsl:text>
															<xsl:value-of select="./*[local-name()='CodigoEntidad']"/>
															<xsl:text>) </xsl:text>
															<xsl:value-of select="./*[local-name()='LiteralEntidad']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
										...
										<fo:table-row>
											...
											<fo:table-cell padding="2pt" display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:value-of select="format-number(./*[local-name()='ImporteBruto'] div 100, '0.00')"/>  
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell padding="2pt" display-align="center"  >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:value-of select="format-number(./*[local-name()='ImporteLiquido'] div 100, '0.00')"/> 	
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
										...
										<fo:table-row>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:if test="./*[local-name()='FechaFin'] !=''">
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:if test="./*[local-name()='FechaHechoCausante'] !=''">
																<xsl:value-of select="concat(substring(string(./*[local-name()='FechaHechoCausante']),9,2),'/',substring(string(./*[local-name()='FechaHechoCausante']),6,2),'/',substring(string(./*[local-name()='FechaHechoCausante']),1,4))"/>
															</xsl:if>
														</fo:inline>
													</fo:block>
												</fo:block>
										...
										<fo:table-row>
											<fo:table-cell padding="2pt" display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Fecha de efectos:</xsl:text>
															<fo:leader leader-pattern="space"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											...
											<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="3">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:if test="./*[local-name()='FechadeEfectos'] !=''">
																<xsl:value-of select="concat(substring(string(./*[local-name()='FechadeEfectos']),9,2),'/',substring(string(./*[local-name()='FechadeEfectos']),6,2),'/',substring(string(./*[local-name()='FechadeEfectos']),1,4))"/>
															</xsl:if>
														</fo:inline>
													</fo:block>
												</fo:block>
										...
										<fo:table-row>
											<fo:table-cell padding="2pt" display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Tipo de pago:</xsl:text> 
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="2pt" display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:choose>
																<xsl:when test="./*[local-name()='TipodePago']='1'"><xsl:text>Directo</xsl:text></xsl:when>
																<xsl:when test="./*[local-name()='TipodePago']='2'"><xsl:text>Delegado</xsl:text></xsl:when>
																<xsl:when test="./*[local-name()='TipodePago']='3'"><xsl:text>Mutua</xsl:text></xsl:when>
															</xsl:choose> 
														</fo:inline>
													</fo:block>
												</fo:block>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:value-of select="./*[local-name()='BaseReguladora']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell> 
								...
								<xsl:variable name="pagos" select="./*[local-name()='Pagos']"/> 
								...
								<xsl:if test="$pagos != ''">
									<fo:table table-layout="fixed" width="100%" space-after="3mm">
										...
										<fo:table table-layout="fixed" width="100%" space-after="3mm">
												...
												<fo:table-row>
													<fo:table-cell padding="0pt" display-align="center" >
														<fo:block text-align="right" margin="0pt">
															<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
																<fo:inline font-weight="bold">
																	<xsl:text>Período pago</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block>
													</fo:table-cell>											
													<fo:table-cell padding="0pt" display-align="center" >
														<fo:block text-align="right" margin="0pt">
															<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
																<fo:inline font-weight="bold">
																	<xsl:text>Importe bruto mes(€)</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block>
													</fo:table-cell>											
													<fo:table-cell padding="0pt" display-align="center" >
														<fo:block text-align="right" margin="0pt">
															<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
																<fo:inline font-weight="bold">
																	<xsl:text>Importe líquido mes(€)</xsl:text>
																</fo:inline>
															</fo:block>
														</fo:block>
													</fo:table-cell>	
											...
											<fo:table-body>
												<xsl:for-each select="$pagos/*[local-name()='Pago']">   
													<fo:table-row> 
														<fo:table-cell padding="2pt" display-align="after">
															<fo:block text-align="right" margin="0pt">
																<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
																	<fo:inline font-style="normal">
																		<xsl:value-of select="./*[local-name()='Periododelpago']"/>  
																	</fo:inline>
																</fo:block>
															</fo:block>
														</fo:table-cell>
														<fo:table-cell padding="2pt" display-align="after">
															<fo:block text-align="right" margin="0pt">
																<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
																	<fo:inline font-style="normal">
																		<xsl:value-of select="format-number(./*[local-name()='ImporteBrutoenelmes'] div 100, '0.00')"/>   
																	</fo:inline>
																</fo:block>
															</fo:block>
														</fo:table-cell>
														<fo:table-cell padding="2pt" display-align="after">
															<fo:block text-align="right" margin="0pt">
																<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
																	<fo:inline font-style="normal">
																		<xsl:value-of select="format-number(./*[local-name()='ImporteLiquidoenelmes'] div 100, '0.00')"/>   
																	</fo:inline>
																</fo:block>
															</fo:block>
														</fo:table-cell>
