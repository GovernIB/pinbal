...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="2.0" xmlns:str="http://www.str.com" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:functx="http://www.functx.com" exclude-result-prefixes="str functx">
	...
	<xsl:template match="//*[local-name()='DatosEspecificos']">
	    ...
	    <!-- DATOS DE LA RESPUESTA	 -->
			<!-- xsl:choose>				
				<xsl:when test="$retorno/*[local-name()='Codigo'] != '0' "-->  
					<fo:block text-align="justify" margin-top="40pt">
						<fo:table table-layout="auto"  width="100%" border-spacing="2pt">
							<fo:table-body start-indent="0pt">
								<fo:table-row>
									<fo:table-cell padding="1" height="30" >
										<fo:block font-family="Arial,sans-serif" font-size="8pt" text-align="justify">
											<fo:inline  font-weight="bold" space-before="25mm" space-after="25mm">
												<xsl:text>RESULTADO DE LA CONSULTA:      </xsl:text>
												<xsl:value-of select="$retorno/*[local-name()='Resultado']"/>
												<xsl:text> - </xsl:text>
