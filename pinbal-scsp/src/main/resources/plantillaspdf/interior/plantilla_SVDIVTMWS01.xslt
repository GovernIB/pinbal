...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="2.0"  xmlns:xs="http://www.w3.org/2001/XMLSchema" >
	...
	<xsl:param name="ConsultaDatosBeneficiarioRelacionParentesco"/>
	<xsl:param name="ConsultaDatosBeneficiarioFechaNacimiento"/>
	<xsl:param name="ConsultaDatosBeneficiarioDerechoReclamado"/>
	<xsl:param name="ConsultaDatosAfectadoFechaNacimiento"/>
	<xsl:param name="ConsultaDatosAfectadoDocumentacion"/>
	<xsl:param name="ConsultaDatosAfectadoNombre"/>
	<xsl:param name="ConsultaDatosAfectadoApellido1"/>
	<xsl:param name="ConsultaDatosAfectadoApellido2"/>
	<xsl:param name="ConsultaDatosBeneficiarioPoblacionNacimiento"/>
	...
	<!-- DATOS DE LA CONSULTA  -->
		...
		<fo:block border-style="solid" border="1px 0 0 0" text-indent="3mm" font-family="Arial,sans-serif" font-size="10pt" space-after="1mm">
			<fo:table table-layout="fixed" border-spacing="5pt" space-before="2mm">
				...
				<fo:table-body start-indent="0pt">
					...
					<fo:table-row>
						<fo:table-cell padding="2pt" display-align="center" background-color="#B0C4DE" number-columns-spanned="6">	
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
								<fo:inline font-weight="bold"> 
									<xsl:text>Datos Afectado</xsl:text>
								</fo:inline>
							</fo:block>			
						</fo:table-cell> 
					</fo:table-row>
					...
					<fo:table-row> 
						...
						<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="3">						
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
									<xsl:value-of select="$ConsultaDatosAfectadoDocumentacion"/>				
							</fo:block>							
						</fo:table-cell> 
						...
						<fo:table-cell padding="2pt" display-align="center" >						
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
									<xsl:value-of select="$ConsultaDatosAfectadoNombre"/><xsl:text> </xsl:text>	
									<xsl:value-of select="$ConsultaDatosAfectadoApellido1"/><xsl:text> </xsl:text> 
									<xsl:value-of select="$ConsultaDatosAfectadoApellido2"/>				
							</fo:block>							
						</fo:table-cell> 
					</fo:table-row> 
					...
					<fo:table-row> 
						...
						<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="5">						
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
								<xsl:value-of select="concat(substring(string($ConsultaDatosAfectadoFechaNacimiento),9,2),'/',substring(string($ConsultaDatosAfectadoFechaNacimiento),6,2),'/',substring(string($ConsultaDatosAfectadoFechaNacimiento),1,4))"/>
					...
					<fo:table-row>
						<fo:table-cell padding="2pt" display-align="center" background-color="#B0C4DE" number-columns-spanned="6">	
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
								<fo:inline font-weight="bold"> 
									<xsl:text>Datos Beneficiario</xsl:text>
								</fo:inline>
							</fo:block>			
						</fo:table-cell> 
					</fo:table-row>	
					...
					<fo:table-row>
						...
						<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="3">						
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
									<xsl:value-of select="concat(substring(string($ConsultaDatosBeneficiarioFechaNacimiento),9,2),'/',substring(string($ConsultaDatosBeneficiarioFechaNacimiento),6,2),'/',substring(string($ConsultaDatosBeneficiarioFechaNacimiento),1,4))"/>
						...
						<fo:table-cell padding="2pt" display-align="center">						
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
									<xsl:value-of select="$ConsultaDatosBeneficiarioPoblacionNacimiento"/>				
							</fo:block>							
						</fo:table-cell>
					</fo:table-row>	
					...
					<fo:table-row>		 
						<fo:table-cell padding="2pt" display-align="center" >							
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
								<fo:inline font-weight="bold"> 
									<xsl:text>Derecho reclamado:</xsl:text> 
								</fo:inline>
							</fo:block>													
						</fo:table-cell>	
						<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="3">						
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
									<xsl:choose>
										<xsl:when test="$ConsultaDatosBeneficiarioDerechoReclamado = '1'">
											<xsl:text>Exención de tasas académicas</xsl:text>
										</xsl:when>
										<xsl:when test="$ConsultaDatosBeneficiarioDerechoReclamado = '2'">
											<xsl:text>Exención de tasas judiciales y asistencia jurídica gratuita</xsl:text>
										</xsl:when>
										<xsl:when test="$ConsultaDatosBeneficiarioDerechoReclamado = '3'">
											<xsl:text>Excención de tasas de derechos de examen</xsl:text>
										</xsl:when>
										<xsl:when test="$ConsultaDatosBeneficiarioDerechoReclamado = '4'">
											<xsl:text>Condición de víctima de terrorismo</xsl:text>
										</xsl:when>
										<xsl:when test="$ConsultaDatosBeneficiarioDerechoReclamado = '5'">
											<xsl:text>Movilidad geográfica y reordenación del tiempo de trabajo</xsl:text>
										</xsl:when>
										<xsl:when test="$ConsultaDatosBeneficiarioDerechoReclamado = '6'">
											<xsl:text>Bonificación laboral y tarifa especial autónomos</xsl:text>
										</xsl:when>
										<xsl:when test="$ConsultaDatosBeneficiarioDerechoReclamado = '7'">
											<xsl:text>Becas de estudio y comedor</xsl:text>
										</xsl:when>
										<xsl:when test="$ConsultaDatosBeneficiarioDerechoReclamado = '8'">
											<xsl:text>Ayudas de libros</xsl:text>
										</xsl:when>
										<xsl:when test="$ConsultaDatosBeneficiarioDerechoReclamado = '9'">
											<xsl:text>Acceso a vivienda</xsl:text>
										</xsl:when>
										<xsl:when test="$ConsultaDatosBeneficiarioDerechoReclamado = '10'">
											<xsl:text>Concursos para provisión de puestos de trabajo</xsl:text>
										</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select="$ConsultaDatosBeneficiarioDerechoReclamado"/>	
										</xsl:otherwise>
						...
						<fo:table-cell padding="2pt" display-align="center" >							
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
								<fo:inline font-weight="bold"> 
									<xsl:text>Relación parentesco:</xsl:text> 
								</fo:inline>
							</fo:block>													
						</fo:table-cell>	 
						...
						<fo:table-cell padding="2pt" display-align="center">						
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
									<xsl:choose>
										<xsl:when test="$ConsultaDatosBeneficiarioRelacionParentesco = '1'">
											<xsl:text>Afectado directo</xsl:text>
										</xsl:when>
										<xsl:when test="$ConsultaDatosBeneficiarioRelacionParentesco = '2'">
											<xsl:text>Padre o madre</xsl:text>
										</xsl:when>
										<xsl:when test="$ConsultaDatosBeneficiarioRelacionParentesco = '3'">
											<xsl:text>Cónyuge</xsl:text>
										</xsl:when>
										<xsl:when test="$ConsultaDatosBeneficiarioRelacionParentesco = '4'">
											<xsl:text>Hermano o hermana</xsl:text>
										</xsl:when>
										<xsl:when test="$ConsultaDatosBeneficiarioRelacionParentesco = '9'">
											<xsl:text>Hijo o hija</xsl:text>
										</xsl:when>
										<xsl:when test="$ConsultaDatosBeneficiarioRelacionParentesco = '10'">
											<xsl:text>Pareja de hecho</xsl:text>
										</xsl:when>
										<xsl:when test="$ConsultaDatosBeneficiarioRelacionParentesco = '12'">
											<xsl:text>Abuelo o abuela</xsl:text>
										</xsl:when>
										<xsl:when test="$ConsultaDatosBeneficiarioRelacionParentesco = '13'">
											<xsl:text>Nieto o nieta</xsl:text>
										</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select="$ConsultaDatosBeneficiarioRelacionParentesco"/>	
										</xsl:otherwise>
									</xsl:choose>
							</fo:block>							
						</fo:table-cell>
		...
		<fo:block margin-top="40pt" text-align="center" font-family="Arial,sans-serif" font-size="10pt" line-height="10pt" space-after.optimum="1pt" display-align="after">
			<fo:inline font-weight="bold">
				...
				<xsl:value-of select="$datosEspecificos/*[local-name()='CodigoEstado']"/> 
				<xsl:text>  -  </xsl:text>
				<xsl:value-of select="$datosEspecificos/*[local-name()='Descripcion']"/> 
			</fo:inline>
		</fo:block>
	</xsl:template>
</xsl:stylesheet>
