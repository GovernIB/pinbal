...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="2.0"  xmlns:xs="http://www.w3.org/2001/XMLSchema" >
	...
	<xsl:param name="UbicacionPoblacion"/>
	...
	<xsl:template match="//*[local-name()='DatosEspecificos']">
		...
		<xsl:variable name="listaCargos" select="$retorno/*[local-name()='ListaCargos']"/>
					...
					<fo:table-row>
					   <!-- Código Procedimiento -->
						<fo:table-cell padding="2pt" display-align="center">							
								<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
									<fo:inline font-weight="bold">
										<xsl:text>Nomb. Procedimiento:    </xsl:text>
									</fo:inline>	
						...
						<!-- Población Peticion -->
						<fo:table-cell padding="2pt" display-align="center">							
								<fo:block font-size="8pt" text-indent="4mm" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
									<fo:inline font-weight="bold">
										<xsl:text>Población:    </xsl:text>
									</fo:inline>	
									<xsl:value-of select="$UbicacionPoblacion"/>								
								</fo:block>													
						</fo:table-cell>				
					</fo:table-row>				
				</fo:table-body>
	    ...
	    <xsl:choose>
			...
			<xsl:when test="$estado/*[local-name()='CodigoEstado'] = '0003'">
				...
				<fo:block border-style="solid" border-width="1px 1px 1px 1px">
					...
					<!-- Panel Firmas -->
					<xsl:if test="$retorno/*[local-name()='ListaCargos']">
						<xsl:for-each select="$retorno/*[local-name()='ListaCargos']/*[local-name()='Cargo']">
							<xsl:variable name="listaCargo" select="position()"/>
							<fo:block margin-top="10pt" margin-left="2pt" margin-right="2pt" text-indent="3mm" font-family="Arial,sans-serif" font-size="10pt" space-before="5mm" space-after="4mm">
										...
										<fo:table-row>
												...
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:value-of select="./*[local-name()='Titular']/*[local-name()='Nombre']"/>
															<xsl:text> </xsl:text>
															<xsl:value-of select="./*[local-name()='Titular']/*[local-name()='Apellido1']"/>
															<xsl:text> </xsl:text>
															<xsl:value-of select="./*[local-name()='Titular']/*[local-name()='Apellido2']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:value-of select="./*[local-name()='Ubicacion']/*[local-name()='NombrePais']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:value-of select="./*[local-name()='Ubicacion']/*[local-name()='Poblacion']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
										...
										<fo:table-row>
											...
											<fo:table-cell display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:value-of select="./*[local-name()='Descripcion']/*[local-name()='Puesto']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:value-of select="./*[local-name()='Descripcion']/*[local-name()='Departamento']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
									...
									<fo:table-body start-indent="0pt">
										<fo:table-row>
											<fo:table-cell display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" display-align="after">
														<xsl:if test="./*[local-name()='FechaAlta']">
															<fo:inline font-weight="bold">
														...
														<xsl:if test="./*[local-name()='FechaBaja']">
															<fo:inline font-weight="bold">
																<xsl:text>Fecha Alta: </xsl:text>
															</fo:inline>
															<fo:inline font-style="normal">
																<xsl:value-of select="./*[local-name()='FechaBaja']"/>
															</fo:inline>
														</xsl:if>
													</fo:block>
												</fo:block>
								...
								<fo:table table-layout="fixed" width="100%" space-after="0mm">
									<fo:table-body start-indent="0pt">
										<fo:table-row>
											<fo:table-cell display-align="center" padding-left="200px">
												<fo:block text-align="left" margin="0pt">
													<xsl:variable name="imagen" select="./*[local-name()='Firma']/*[local-name()='DatosImagen']"/>
													<fo:external-graphic content-width="scale-to-fit" content-height="150px" width="150px" scaling="uniform" src="url('data:image/jpeg;base64,{$imagen}')"/>
												</fo:block>
											</fo:table-cell>
										</fo:table-row>
									</fo:table-body>
