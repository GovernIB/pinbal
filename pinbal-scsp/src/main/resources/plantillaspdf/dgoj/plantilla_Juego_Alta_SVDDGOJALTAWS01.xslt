...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="2.0" xmlns:str="http://www.str.com" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:functx="http://www.functx.com" exclude-result-prefixes="str functx">
	...
	<xsl:param name="ConsultaSolicitudAltaFechaNacimiento"/>
	<xsl:param name="ConsultaSolicitudAltaSexo"/>
	<xsl:param name="ConsultaSolicitudAltaCodigoProvincia"/>
	<xsl:param name="ConsultaSolicitudAltaCodigoMunicipio"/>
	<xsl:param name="ConsultaSolicitudAltaDomicilio"/>
	<xsl:param name="ConsultaSolicitudAltaCodigoPostal"/>
	<xsl:param name="ConsultaSolicitudAltaTelefono"/>
	<xsl:param name="ConsultaSolicitudAltaEmail"/>
	<xsl:param name="ConsultaSolicitudAltaObservaciones"/>
	<xsl:template match="/">
		<fo:root>
				...
				<fo:table-body start-indent="0pt">
					<fo:table-row>
					   <!-- Sexo -->
						...
						<fo:table-cell padding="2pt" display-align="center">						
								<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
									<xsl:value-of select="$ConsultaSolicitudAltaSexo"/>
								</fo:block>	
						</fo:table-cell>
						<!-- Num Soporte -->
						<fo:table-cell padding="2pt" display-align="center">						
							...
							<fo:table-cell padding="2pt" display-align="center">						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
										<xsl:if test="$ConsultaSolicitudAltaFechaNacimiento != '' ">
											<xsl:value-of select="concat(substring(string($ConsultaSolicitudAltaFechaNacimiento),1,2),'/',substring(string($ConsultaSolicitudAltaFechaNacimiento),4,2),'/',substring(string($ConsultaSolicitudAltaFechaNacimiento),7,4))"/>
										</xsl:if>
									</fo:block>	
							</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-body start-indent="0pt">
						<fo:table-row>
						   <!-- Fecha nacimiento -->
							...
							<fo:table-cell padding="2pt" display-align="center">						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" > 
											<xsl:value-of select="$ConsultaSolicitudAltaCodigoProvincia"/>  
									</fo:block>	
							</fo:table-cell>
							<!-- Nivel obtenido -->
							<fo:table-cell padding="2pt" display-align="center">						
							...
							<fo:table-cell padding="2pt" display-align="center">						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
										<xsl:value-of select="$ConsultaSolicitudAltaCodigoMunicipio"/>
									</fo:block>	
							</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
							...
							<fo:table-cell padding="2pt" display-align="center"   >						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
										<xsl:value-of select="$ConsultaSolicitudAltaCodigoPostal"/> 
									</fo:block>	
							</fo:table-cell>
							<fo:table-cell padding="2pt" display-align="center">						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
							...
							<fo:table-cell padding="2pt" display-align="center"   >						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
										<xsl:value-of select="$ConsultaSolicitudAltaDomicilio"/> 
									</fo:block>	
							</fo:table-cell>
						</fo:table-row>
						<xsl:if test="$ConsultaSolicitudAltaEmail != ''">
							<fo:table-row>
									<fo:table-cell padding="2pt" display-align="center">						
											<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
												<fo:inline font-weight="bold">
									...
									<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="3"  >						
											<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
												<xsl:value-of select="$ConsultaSolicitudAltaEmail"/> 
											</fo:block>	
									</fo:table-cell>
							</fo:table-row>
						</xsl:if>
						<xsl:if test="$ConsultaSolicitudAltaTelefono != ''">
							<fo:table-row>
									<fo:table-cell padding="2pt" display-align="center">						
											<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
												<fo:inline font-weight="bold">
									...
									<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="3"  >						
											<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
												<xsl:value-of select="$ConsultaSolicitudAltaTelefono"/> 
											</fo:block>	
									</fo:table-cell>
							</fo:table-row>
						</xsl:if>
						<xsl:if test="$ConsultaSolicitudAltaObservaciones != ''">
							<fo:table-row>
									<fo:table-cell padding="2pt" display-align="center">						
											<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
												<fo:inline font-weight="bold">
									...
									<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="3"  >						
											<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
												<xsl:value-of select="$ConsultaSolicitudAltaObservaciones"/> 
											</fo:block>	
									</fo:table-cell>
							</fo:table-row>
						</xsl:if>
