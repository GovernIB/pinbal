...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="2.0" xmlns:str="http://www.str.com" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:functx="http://www.functx.com" exclude-result-prefixes="str functx">
	...
	<xsl:param name="ConsultaSolicitudModificacionFechaNacimiento"/>
	<xsl:param name="ConsultaSolicitudModificacionSexo"/>
	<xsl:param name="ConsultaSolicitudModificacionCodigoProvincia"/>
	<xsl:param name="ConsultaSolicitudModificacionCodigoMunicipio"/>
	<xsl:param name="ConsultaSolicitudModificacionDomicilio"/>
	<xsl:param name="ConsultaSolicitudModificacionCodigoPostal"/>
	<xsl:param name="ConsultaSolicitudModificacionTelefono"/>
	<xsl:param name="ConsultaSolicitudModificacionEmail"/>
	<xsl:param name="ConsultaSolicitudModificacionObservaciones"/>
	<xsl:template match="/">
		<fo:root>
				...
				<fo:table-body start-indent="0pt">
					<fo:table-row>
					   <!-- Sexo -->
						...
						<fo:table-cell padding="2pt" display-align="center">						
								<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
									<xsl:value-of select="$ConsultaSolicitudModificacionSexo"/>
								</fo:block>	
						</fo:table-cell>
						<!-- Num Soporte -->
						<fo:table-cell padding="2pt" display-align="center">						
							...
							<fo:table-cell padding="2pt" display-align="center">						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
										<xsl:if test="$ConsultaSolicitudModificacionFechaNacimiento != '' ">
											<xsl:value-of select="concat(substring(string($ConsultaSolicitudModificacionFechaNacimiento),1,2),'/',substring(string($ConsultaSolicitudModificacionFechaNacimiento),4,2),'/',substring(string($ConsultaSolicitudModificacionFechaNacimiento),7,4))"/>
										</xsl:if>
									</fo:block>	
							</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-body start-indent="0pt">
						<fo:table-row>
						   <!-- Fecha nacimiento -->
							...
							<fo:table-cell padding="2pt" display-align="center">						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" > 
											<xsl:value-of select="$ConsultaSolicitudModificacionCodigoProvincia"/>  
									</fo:block>	
							</fo:table-cell>
							<!-- Nivel obtenido -->
							<fo:table-cell padding="2pt" display-align="center">						
							...
							<fo:table-cell padding="2pt" display-align="center">						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
										<xsl:value-of select="$ConsultaSolicitudModificacionCodigoMunicipio"/>
									</fo:block>	
							</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
							...
							<fo:table-cell padding="2pt" display-align="center"   >						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
										<xsl:value-of select="$ConsultaSolicitudModificacionCodigoPostal"/> 
									</fo:block>	
							</fo:table-cell>
							<fo:table-cell padding="2pt" display-align="center">						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
							...
							<fo:table-cell padding="2pt" display-align="center"   >						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
										<xsl:value-of select="$ConsultaSolicitudModificacionDomicilio"/> 
									</fo:block>	
							</fo:table-cell>
						</fo:table-row>
						<xsl:if test="$ConsultaSolicitudModificacionEmail != ''">
							<fo:table-row>
									<fo:table-cell padding="2pt" display-align="center">						
											<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
												<fo:inline font-weight="bold">
									...
									<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="3"  >						
											<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
												<xsl:value-of select="$ConsultaSolicitudModificacionEmail"/> 
											</fo:block>	
									</fo:table-cell>
							</fo:table-row>
						</xsl:if>
						<xsl:if test="$ConsultaSolicitudModificacionTelefono != ''">
							<fo:table-row>
									<fo:table-cell padding="2pt" display-align="center">						
											<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
												<fo:inline font-weight="bold">
									...
									<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="3"  >						
											<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
												<xsl:value-of select="$ConsultaSolicitudModificacionTelefono"/> 
											</fo:block>	
									</fo:table-cell>
							</fo:table-row>
						</xsl:if>
						<xsl:if test="$ConsultaSolicitudModificacionObservaciones != ''">
							<fo:table-row>
									<fo:table-cell padding="2pt" display-align="center">						
											<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
												<fo:inline font-weight="bold">
									...
									<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="3"  >						
											<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
												<xsl:value-of select="$ConsultaSolicitudModificacionObservaciones"/> 
											</fo:block>	
									</fo:table-cell>
							</fo:table-row>
						</xsl:if>
				...
				<xsl:when test="$estado/*[local-name()='CodigoEstado'] = '0' ">
					<fo:block margin-top="40pt" text-align="center" font-family="Arial,sans-serif" font-size="10pt" line-height="10pt" space-after.optimum="1pt" display-align="after">
						<fo:inline font-weight="bold">
							...
							<xsl:text>  -  </xsl:text>
							<!-- xsl:value-of select="$estado/*[local-name()='LiteralError']"/ -->
							<xsl:text>Registro realizado de manera satisfactoria</xsl:text>
						</fo:inline>
					</fo:block>
				</xsl:when>
			</xsl:choose>
