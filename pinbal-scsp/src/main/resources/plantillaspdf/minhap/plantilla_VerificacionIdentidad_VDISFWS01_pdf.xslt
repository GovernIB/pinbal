...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="2.0" xmlns:str="http://www.str.com" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:functx="http://www.functx.com" exclude-result-prefixes="str functx">
	...
	<xsl:param name="SolicitudSexo"/>
	<xsl:param name="SolicitudNumSoporte"/>
	<xsl:param name="DatosNacimientoFecha"/>
	<xsl:param name="DatosNacimientoPais"/>
	<xsl:param name="DatosNacimientoProvincia"/>
	...
	<xsl:template match="//*[local-name()='DatosEspecificos']">
		...
		<xsl:if test="$SolicitudSexo !='' or $SolicitudNumSoporte !='' ">			
				...
				<fo:table-body start-indent="0pt">
					<fo:table-row>
					   <!-- Sexo -->
						...
						<fo:table-cell padding="2pt" display-align="center">						
								<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
									<xsl:value-of select="$SolicitudSexo"/>
								</fo:block>	
						</fo:table-cell>
						<!-- Num Soporte -->
						<fo:table-cell padding="2pt" display-align="center">						
			...
			<xsl:if test="$DatosNacimientoFecha != '' or $DatosNacimientoPais != '' or $DatosNacimientoProvincia != ''">
					...
					<fo:table-body start-indent="0pt">
						<fo:table-row>
						   <!-- Fecha Nacimiento -->
							...
							<fo:table-cell padding="2pt" display-align="center">						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
										<xsl:if test="$DatosNacimientoFecha != '' ">
											<xsl:value-of select="concat(substring(string($DatosNacimientoFecha),7,2),'/',substring(string($DatosNacimientoFecha),5,2),'/',substring(string($DatosNacimientoFecha),1,4))"/>
										</xsl:if>
									</fo:block>	
							</fo:table-cell>
							<!-- País Nacimiento -->
							...
							<fo:table-cell padding="2pt" display-align="center">						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
										<xsl:value-of select="$DatosNacimientoPais"/>
									</fo:block>	
							</fo:table-cell>
							...
							<fo:table-cell padding="2pt" display-align="center">						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
										<xsl:value-of select="$DatosNacimientoProvincia"/> 
									</fo:block>	
							</fo:table-cell>
						</fo:table-row>
					</fo:table-body>
