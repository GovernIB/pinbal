...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="2.0" xmlns:str="http://www.str.com" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:functx="http://www.functx.com" exclude-result-prefixes="str functx">
	...
	<xsl:param name="ConsultaCodigoProvincia"/>
	<xsl:param name="ConsultaConsentimientoTiposDiscapacidad"/>
	<xsl:param name="ConsultaExpediente"/>
	<xsl:param name="ConsultaDatosAdicionalesTitularFechaNacimiento"/>
	<xsl:param name="ConsultaFechaConsulta"/>
				...
				<fo:table-body start-indent="0pt">
					<fo:table-row>
						...
						<fo:table-cell padding="2pt" display-align="center">
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">							
								<xsl:choose>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '01' ">
															<xsl:text>Andalucía</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '02' ">
															<xsl:text>Aragón</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '03' ">
															<xsl:text>Principado de Asturias</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '04' ">
															<xsl:text>Islas Baleares</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '05' ">
															<xsl:text>Canarias</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '06' ">
															<xsl:text>Cantabria</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '07' ">
															<xsl:text>Castilla y León</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '08' ">
															<xsl:text>Castilla-La Mancha</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '09' ">
															<xsl:text>Cataluña</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '10' ">
															<xsl:text>Comunidad Valenciana</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '11' ">
															<xsl:text>Extremadura</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '12' ">
															<xsl:text>Galicia</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '13' ">
															<xsl:text>Madrid</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '14' ">
															<xsl:text>Región de Murcia</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '15' ">
															<xsl:text>Navarra</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '16' ">
															<xsl:text>País Vasco</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '17' ">
															<xsl:text>La Rioja</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '18' ">
															<xsl:text>Ciudad de Ceuta</xsl:text>
														</xsl:when>
														<xsl:when test="$ConsultaCodigoComunidadAutonoma = '19' ">
						...
						<fo:table-cell padding="2pt" display-align="center">
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
								<fo:inline font-weight="bold">
									<xsl:text>Cod. Provincia:</xsl:text>
								</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell padding="2pt" display-align="center">
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
								<xsl:value-of select="$ConsultaCodigoProvincia"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row>
						<fo:table-cell padding="2pt" display-align="center">
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
								<fo:inline font-weight="bold">
									<xsl:text>Expediente Discapacidad:</xsl:text>
								</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell padding="2pt" display-align="center">
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
								<xsl:value-of select="$ConsultaExpediente"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell padding="2pt" display-align="center">
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
								<fo:inline font-weight="bold">
									<xsl:text>Consentimiento Tipos Discapacidad:</xsl:text>
								</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell padding="2pt" display-align="center">
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
								<xsl:value-of select="$ConsultaConsentimientoTiposDiscapacidad"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row>
						...
						<fo:table-cell padding="2pt" display-align="center">
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
								<xsl:value-of select="$ConsultaFechaConsulta"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell padding="2pt" display-align="center">
							<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
			...
			<xsl:when test="$datosEspecificos/*[local-name()='Estado']/*[local-name()='CodigoEstado'] = '0'">
				...
				<fo:block border-style="solid" border-width="1px 1px 1px 1px">
					<fo:block text-indent="3mm" margin-top="2pt" margin-left="2pt" margin-right="2pt" font-family="Arial,sans-serif" font-size="10pt" space-before="1mm" space-after="4mm">
							...
							<fo:table-body start-indent="0pt">
								<fo:table-row>
									<fo:table-cell padding="3pt" display-align="center" background-color="#B0C4DE">
										<fo:block>
											<fo:inline font-weight="bold" display-align="after">
												<xsl:text>Certificado datos discapacidad</xsl:text>
											</fo:inline>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
						...
						<fo:table table-layout="fixed" width="100%" border-spacing="5pt" space-after="2mm">
							...
							<fo:table-body start-indent="0pt">
								<fo:table-row>
									...
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="normal">
													<xsl:value-of select="$datosEspecificos/*[local-name()='DatosAdicionalesTitularRespuesta']/*[local-name()='FechaNacimiento']"/>
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
									...
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="normal">
													<xsl:value-of select="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='Expediente']"/>													
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
								...
								<fo:table-row>
									...
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="normal">
													<xsl:choose>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '01' ">
															<xsl:text>Andalucía</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '02' ">
															<xsl:text>Aragón</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '03' ">
															<xsl:text>Principado de Asturias</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '04' ">
															<xsl:text>Islas Baleares</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '05' ">
															<xsl:text>Canarias</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '06' ">
															<xsl:text>Cantabria</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '07' ">
															<xsl:text>Castilla y León</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '08' ">
															<xsl:text>Castilla-La Mancha</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '09' ">
															<xsl:text>Cataluña</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '10' ">
															<xsl:text>Comunidad Valenciana</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '11' ">
															<xsl:text>Extremadura</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '12' ">
															<xsl:text>Galicia</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '13' ">
															<xsl:text>Madrid</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '14' ">
															<xsl:text>Región de Murcia</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '15' ">
															<xsl:text>Navarra</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '16' ">
															<xsl:text>País Vasco</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '17' ">
															<xsl:text>La Rioja</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '18' ">
															<xsl:text>Ciudad de Ceuta</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoComunidadAutonoma'] = '19' ">
															<xsl:text>Ciudad de Melilla</xsl:text>
														</xsl:when>
													</xsl:choose>
												</fo:inline>
									...
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="normal">
													<xsl:value-of select="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='CodigoProvincia']"/>
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
								...
								<fo:table-row>											
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" text-decoration="underline" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="bold">
													<xsl:text>Datos relativos discapacidad</xsl:text>
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
								...
								<fo:table-row>											
									...
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="normal">
													<xsl:value-of select="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='GradoDiscapacidad']"/>														
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
									...
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
											      <xsl:if test="//*[local-name()='DatosEspecificos']/*[local-name()='Retorno']/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='TiposDiscapacidad'] != '' ">
														<fo:inline font-weight="normal">															
															<fo:table table-layout="fixed" width="100%" border-spacing="5pt" space-after="2mm">								
																<fo:table-body start-indent="0pt">
																	<xsl:for-each select="//*[local-name()='DatosEspecificos']/*[local-name()='Retorno']/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='TiposDiscapacidad']/*[local-name()='TipoDiscapacidad']">															
																		<xsl:variable name="discapacidad" select="current()"/>
																			<fo:table-row>
																				<fo:table-cell>
																					<fo:block text-align="left" margin="0pt">
																						<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
																							<fo:inline font-weight="normal">
																								<xsl:value-of select="$discapacidad"/>
																							</fo:inline>
																						</fo:block>
																					</fo:block>
																				</fo:table-cell>
								...
								<fo:table-row>											
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" text-decoration="underline" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="bold">
													<xsl:text>Datos relativos movilidad</xsl:text>
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
								...
								<fo:table-row>											
									...
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="normal">
													<xsl:value-of select="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='RespuestaMovilidad']/*[local-name()='Puntuacion']"/>														
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
									...
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="normal">
													<xsl:value-of select="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='RespuestaMovilidad']/*[local-name()='Factor']"/>
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
								 ...
								 <fo:table-row>
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="bold">
													<xsl:text>Fecha efectos:</xsl:text>
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="normal">
														<xsl:value-of select="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='FechaEfectos']"/> 
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="bold">
													<xsl:text>Validez permanente:</xsl:text>
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="normal">
													<xsl:choose>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='ValidezPermanente'] = 'S' ">
															<xsl:text>Sí</xsl:text>
														</xsl:when>
														<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='ValidezPermanente'] = 'N' ">
								...
								<fo:table-row>
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="bold">
													<xsl:text>Fecha revisión:</xsl:text>
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
									<fo:table-cell padding="2pt" display-align="center">
										<fo:block text-align="left" margin="0pt">
											<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
												<fo:inline font-weight="normal">
														<xsl:value-of select="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='FechaRevision']"/> 
												</fo:inline>
											</fo:block>
										</fo:block>
									</fo:table-cell>
						...
						<fo:table table-layout="fixed" width="100%" border-spacing="5pt">
									...
									<fo:table-row>								    
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-weight="bold">
														<xsl:text>Tiene baremo de dependencia reconocido:</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:block>
										</fo:table-cell>
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-weight="normal">
														<xsl:choose>
															<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='Dependencia'] = 'S' ">
																<xsl:text>Sí</xsl:text>
															</xsl:when>
															<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='Dependencia'] = 'N' ">
																<xsl:text>No</xsl:text>
															</xsl:when>
														</xsl:choose>
													</fo:inline>
									...
									<fo:table-row>
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-weight="bold">
														<xsl:text>Necesita acompañante para el transporte público:</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:block>
										</fo:table-cell>
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-weight="normal">
														<xsl:choose>
															<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='RespuestaAcompananteTPublico'] = 'S' ">
																<xsl:text>Sí</xsl:text>
															</xsl:when>
															<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='RespuestaAcompananteTPublico'] = 'N' ">
																<xsl:text>No</xsl:text>
															</xsl:when>
														</xsl:choose>
													</fo:inline>
										...
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-weight="bold">
														<xsl:choose>
															<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='RespuestaDependencia'] = 'S' ">
																<xsl:text>Dependencia:</xsl:text>
															</xsl:when>
															<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='RespuestaDependencia'] = 'N' ">
																<xsl:text>Dependencia:</xsl:text>
															</xsl:when>
															<xsl:when test="$datosEspecificos/*[local-name()='CertificadoDatosDiscapacidad']/*[local-name()='RespuestaDependencia'] = '' ">
																<xsl:text></xsl:text>
															</xsl:when>
														</xsl:choose>	
													</fo:inline>
