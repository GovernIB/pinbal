...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="2.0" xmlns:str="http://www.str.com" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:functx="http://www.functx.com" exclude-result-prefixes="str functx">
	...
	<xsl:param name="SolicitudNumSoporte"/>
	...
	<xsl:template match="//*[local-name()='DatosEspecificos']">
		...
		<xsl:variable name="datosTitular" select="//*[local-name()='TransmisionDatos']/*[local-name()='DatosEspecificos']/*[local-name()='DatosTitular']"/>
					...
					<fo:table-row>
							<fo:table-cell padding="2pt" display-align="center">						
								<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
									...
									<xsl:value-of select="$SolicitudNumSoporte"/>
								</fo:block>													
						</fo:table-cell>				
					</fo:table-row>				
				</fo:table-body>
											...
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-style="normal">
														<xsl:value-of select="$datosTitular/*[local-name()='Identificador']"/>
													</fo:inline>
												</fo:block>
											</fo:block>
										</fo:table-cell>
									...
									<fo:table-row>
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-weight="bold">
														<xsl:text>Nº Soporte / TIE:</xsl:text>
														<!-- fo:leader leader-pattern="space" / -->
													</fo:inline>
												</fo:block>
											</fo:block>
										...
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-style="normal">
														<xsl:value-of select="$datosTitular/*[local-name()='NumSoporte']"/>
													</fo:inline>
												</fo:block>
											</fo:block>
										</fo:table-cell>
										...
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-style="normal">
														<xsl:value-of select="$datosTitular/*[local-name()='NomPadre']"/>
														<xsl:if test=" $datosTitular/*[local-name()='NomPadre'] != '' and $datosTitular/*[local-name()='NomMadre'] != '' ">
																<xsl:text>/</xsl:text>
														</xsl:if>  
														 <xsl:value-of select="$datosTitular/*[local-name()='NomMadre']"/>
													</fo:inline>
												</fo:block>
											</fo:block>
										</fo:table-cell>
									...
									<fo:table-row>
										...
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-style="normal">
														<xsl:if test="$datosNacimiento/*[local-name()='Fecha'] != ''">														
									...
									<fo:table-row>
										...
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-style="normal">
														<xsl:value-of select="$datosTitular/*[local-name()='Sexo']"/>
													</fo:inline>
												</fo:block>
											</fo:block>
										</fo:table-cell>
									...
									<fo:table-row>
										...
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-style="normal">
														<xsl:value-of select="$datosDireccion/*[local-name()='DatosVia']"/>
													</fo:inline>
												</fo:block>
											</fo:block>
										</fo:table-cell>
										...
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-style="normal">
														<xsl:value-of select="$datosDireccion/*[local-name()='Provincia']"/>
													</fo:inline>
												</fo:block>
											</fo:block>
										</fo:table-cell>
									...
									<fo:table-row>
										...
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-style="normal">
														<xsl:value-of select="$datosDireccion/*[local-name()='Localidad']"/>
													</fo:inline>
												</fo:block>
											</fo:block>
										</fo:table-cell>
									...
									<fo:table-row>
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-weight="bold">
														<xsl:text>Fecha de Caducidad:</xsl:text>
														<!-- fo:leader leader-pattern="space" / -->
													</fo:inline>
												</fo:block>
											</fo:block>
