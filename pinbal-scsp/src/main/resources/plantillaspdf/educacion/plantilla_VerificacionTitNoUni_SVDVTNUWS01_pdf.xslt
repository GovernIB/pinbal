...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="2.0"  xmlns:xs="http://www.w3.org/2001/XMLSchema" >
	...
	<xsl:param name="ConsultaDatosTitularFechaNacimiento"/>
	<xsl:param name="ConsultaDatosTituloCodigoUniversidad"/>
	<xsl:param name="ConsultaDatosTituloNumeroTitulo"/>
		...
		<fo:block border-style="solid" border="1px 0 0 0" text-indent="3mm" font-family="Arial,sans-serif" font-size="10pt" space-after="1mm">
			<fo:table table-layout="fixed" border-spacing="5pt" space-before="2mm">
				...
				<fo:table-body start-indent="0pt">
					...
					<xsl:if test="$ConsultaDatosTitularFechaNacimiento != ''">
						<fo:table-row> 
							<fo:table-cell padding="2pt" display-align="center"  background-color="#B0C4DE" number-columns-spanned="6">	 					
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" 
						...
						<fo:table-row> 
							...
							<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="5" >						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
											<xsl:value-of select="$ConsultaDatosTitularFechaNacimiento"/>					
									</fo:block>							
							</fo:table-cell> 
						</fo:table-row>		
					</xsl:if>	
						...
						<fo:table-row>  
							<fo:table-cell padding="2pt" display-align="center" >							
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
										<fo:inline font-weight="bold">
											<xsl:text>Número título:</xsl:text>
										</fo:inline>
							...
							<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="5" >						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
											<xsl:value-of select="$ConsultaDatosTituloNumeroTitulo"/>					
									</fo:block>							
							</fo:table-cell>  
						</fo:table-row>		
				</fo:table-body>
		...
		<xsl:choose>  
			...
			<xsl:when test="$estado/*[local-name()='CodigoEstado'] = '0'">
				...
				<fo:block border-style="solid" border-width="1px 1px 1px 1px">
						...
						<fo:block margin-top="10pt" margin-left="2pt" margin-right="2pt" text-indent="3mm" font-family="Arial,sans-serif" font-size="10pt" space-before="5mm" space-after="4mm">
							<fo:table table-layout="fixed" width="100%" border-spacing="5pt" space-after="2mm">
								...
								<fo:table-body start-indent="0pt">
									...
									<xsl:if test="$datosEspecificos/*[local-name()='DatosTitular']">
										<fo:table-row>
											<fo:table-cell padding="2pt" display-align="center" >	 					
												<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" 
													space-after.optimum="1pt" display-align="after" >
											...
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-style="normal">
														<xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitular']/*[local-name()='FechaNacimiento']"/>
													</fo:inline>
												</fo:block>
											</fo:block>
										</fo:table-cell> 	
					...
					<fo:block margin-top="10pt" margin-left="2pt" margin-right="2pt" text-indent="3mm" font-family="Arial,sans-serif" font-size="10pt" space-before="5mm" space-after="4mm">
						<xsl:if test="$datosEspecificos/*[local-name()='DatosTitulacion']">	
							<fo:block text-indent="3mm" margin-top="2pt" margin-left="2pt" margin-right="2pt" font-family="Arial,sans-serif" font-size="10pt" space-before="5mm" space-after="4mm">
								<fo:table table-layout="fixed" width="100%" border-spacing="5pt" space-after="2mm">
									<fo:table-body start-indent="0pt">
										<fo:table-row>
											<fo:table-cell padding="3pt" display-align="center" background-color="#B0C4DE">
												<fo:block>
													<fo:inline font-weight="bold" display-align="after">
														<xsl:text>Datos titulación</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
										</fo:table-row>
							...
							<fo:table table-layout="fixed" width="100%" border-spacing="5pt" space-after="2mm">
								...
								<fo:table-body start-indent="0pt"> 
									<xsl:if test="$datosEspecificos/*[local-name()='DatosTitulacion']">	 
										...
										<xsl:if test="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosCentro']">
											<fo:table-row>
												<fo:table-cell padding="2pt" display-align="center"  background-color="#B0C4DE" number-columns-spanned="6">	 					
													<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" 
														space-after.optimum="1pt" display-align="after" >
														<fo:inline font-weight="bold">
															<xsl:text>Datos del centro</xsl:text>
														</fo:inline> 
													</fo:block>													
												</fo:table-cell>	
											</fo:table-row> 
												...
												<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="5">
													<fo:block text-align="left" margin="0pt">
														<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
															<fo:inline font-style="normal"> 
																	<xsl:text>( </xsl:text>
																	<xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosCentro']/*[local-name()='CodigoCentro']"/>
																	<xsl:text> ) </xsl:text>
																	<xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosCentro']/*[local-name()='Centro']"/>
															</fo:inline>
														</fo:block>
													</fo:block>
												</fo:table-cell>  
										...
										<fo:table-row>
											<fo:table-cell padding="2pt" display-align="center"  background-color="#B0C4DE" number-columns-spanned="6">	 					
												<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" 
													space-after.optimum="1pt" display-align="after" >
													<fo:inline font-weight="bold">
														<xsl:text>Datos del título</xsl:text>
													</fo:inline> 
												</fo:block>													
											</fo:table-cell>	
										</fo:table-row> 
									  	...
									  	<fo:table-row>
											...
											<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="5">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:if test="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='CodigoTitulacion']">
																<xsl:text>( </xsl:text>
																<xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='CodigoTitulacion']"/>
																<xsl:text> ) </xsl:text>
																<xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='Titulacion']"/>
															</xsl:if>
														</fo:inline>
													</fo:block>
												</fo:block>
										...
										<fo:table-row>
											...
											<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="5">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:if test="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='CodigoTipoTitulo']">
																<xsl:text>( </xsl:text>
																<xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='CodigoTipoTitulo']"/>
																<xsl:text> ) </xsl:text>
																<xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='TipoTitulo']"/>
															</xsl:if>
														</fo:inline>
													</fo:block>
												</fo:block>
										...
										<fo:table-row>
											...
											<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="2">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															 <xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='TipoEstudio']"/>
														 </fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>  
											...
											<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="2">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal"> 
																<xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='Nivel']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>  
										...
										<fo:table-row>
											...
											<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="2" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															 <xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='FechaExpedicion']"/>
														 </fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>  
											...
											<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="2">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:if test="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='CodigoPaisExpedicion']">
																<xsl:text>( </xsl:text>
																<xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='CodigoPaisExpedicion']"/>
																<xsl:text> ) </xsl:text>
																<xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='PaisExpedicion']"/>
															</xsl:if>
										...
										<fo:table-row>
											<fo:table-cell padding="2pt" display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Nº registro autonómico:</xsl:text>
															<fo:leader leader-pattern="space"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											...
											<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="2">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															 <xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='NumeroRegistroAutonomico']"/>
														 </fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>  
											<fo:table-cell padding="2pt" display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Nº registro MEC:</xsl:text>
															<fo:leader leader-pattern="space"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											...
											<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="2">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal"> 
															<xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='NumeroRegistroMec']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>  
										...
										<fo:table-row>
											<fo:table-cell padding="2pt" display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Nº orden libro:</xsl:text>
															<fo:leader leader-pattern="space"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											...
											<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="2">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															 <xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='Registro']/*[local-name()='NumeroOrdenLibro']"/>
														 </fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>  
											...
											<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="2" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal"> 
															<xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='Registro']/*[local-name()='NumeroLibro']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>  
										...
										<fo:table-row>
											<fo:table-cell padding="2pt" display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Número folio:</xsl:text>
															<fo:leader leader-pattern="space"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											...
											<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="5" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal"> 
															<xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='Registro']/*[local-name()='NumeroFolio']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>  
