					...
					<xsl:if test="$ConsultaDatosTitularFechaNacimiento != ''">
						...
						<fo:table-row>   
							...
							<fo:table-cell padding="2pt" display-align="center" >							
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
										<fo:inline font-weight="bold">
											<xsl:if test="$ConsultaDatosTituloCodigoUniversidad != ''">
												<xsl:text>Cód. universidad:</xsl:text>
											</xsl:if>
										</fo:inline>
							...
							<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="3">						
									<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after" >
											<xsl:if test="$ConsultaDatosTituloCodigoUniversidad != ''">
												<xsl:value-of select="$ConsultaDatosTituloCodigoUniversidad"/>	
											</xsl:if>				
									</fo:block>							
							</fo:table-cell> 
						</fo:table-row>		
		...
		<xsl:choose>  
			...
			<xsl:when test="$estado/*[local-name()='CodigoEstado'] = '0'">
				...
				<fo:block border-style="solid" border-width="1px 1px 1px 1px">
						...
						<fo:block margin-top="10pt" margin-left="2pt" margin-right="2pt" text-indent="3mm" font-family="Arial,sans-serif" font-size="10pt" space-before="5mm" space-after="4mm">
							<fo:table table-layout="fixed" width="100%" border-spacing="5pt" space-after="2mm">
								...
								<fo:table-body start-indent="0pt">
									...
									<xsl:if test="$datosEspecificos/*[local-name()='DatosTitular'] and not($datosTitular) "> 
										<fo:table-row>
											<fo:table-cell padding="2pt" display-align="center" >	 					
												<fo:block font-size="8pt" text-align="left" font-family="Arial,Helvetica,sans-serif" line-height="10pt" 
													space-after.optimum="1pt" display-align="after" >
					...
					<fo:block margin-top="1pt" margin-left="2pt" margin-right="2pt" text-indent="3mm" font-family="Arial,sans-serif" font-size="10pt" space-before="5mm" space-after="4mm">
							<fo:table table-layout="fixed" width="100%" border-spacing="5pt" space-after="2mm">
								<fo:table-column column-width="proportional-column-width(1.1)"/>
								<fo:table-column column-width="proportional-column-width(0.9)"/>
								<fo:table-column column-width="proportional-column-width(0.8)"/>
									  	...
									  	<fo:table-row>
											...
											<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="5">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															<xsl:if test="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosCentro']/*[local-name()='CodigoUniversidad']">
																<xsl:text>( </xsl:text>
																<xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosCentro']/*[local-name()='CodigoUniversidad']"/>
																<xsl:text> ) </xsl:text>
																<xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosCentro']/*[local-name()='Universidad']"/>
															</xsl:if>
														</fo:inline>
													</fo:block>
												</fo:block>
										...
										<fo:table-row>
											...
											<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="2" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal">
															 <xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='NumeroTitulo']"/>
														 </fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>  
											<fo:table-cell padding="2pt" display-align="center">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Registro universitario:</xsl:text> 
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="2pt" display-align="center"  number-columns-spanned="2">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
														<fo:inline font-style="normal"> 
															<xsl:value-of select="$datosEspecificos/*[local-name()='DatosTitulacion']/*[local-name()='DatosTitulo']/*[local-name()='RegistroUniversitario']"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>  
