				...
				<xsl:when test="$estado/*[local-name()='CodigoEstado'] = '0' ">
					...
					<fo:block border-style="solid" border="1px 0 0 0" text-indent="3mm" font-family="Arial,sans-serif" font-size="10pt" space-after="1mm">
											...
											<fo:table-row>
												<fo:table-cell padding="2pt" display-align="center" >
													<fo:block text-align="left" margin="0pt">
														<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
															<fo:inline font-weight="bold">
																<xsl:text>Identificador del certificado:</xsl:text>															
															</fo:inline>
														</fo:block>
													</fo:block>
												</fo:table-cell>
												...
												<fo:table-cell padding="2pt" display-align="center" >
													<fo:block text-align="left" margin="0pt">
														<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
															<fo:inline font-weight="bold">
																<xsl:text>Fecha de expedición:</xsl:text> 
															</fo:inline>
														</fo:block>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="3">
													<fo:block text-align="left" margin="0pt">
														<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
															<fo:inline font-style="normal"> 
																<xsl:value-of select="concat(substring(string($datosEspecificos/*[local-name()='Retorno']/*[local-name()='Certificado']/*[local-name()='FechaExpedicion']),9,2),'/',substring(string($datosEspecificos/*[local-name()='Retorno']/*[local-name()='Certificado']/*[local-name()='FechaExpedicion']),6,2),'/',substring(string($datosEspecificos/*[local-name()='Retorno']/*[local-name()='Certificado']/*[local-name()='FechaExpedicion']),1,4))"/>
															</fo:inline>
														</fo:block>
													</fo:block>
												</fo:table-cell>
						...
						<xsl:if test="$datosCertificado != ''">
											...
											<fo:table-row>
												...
												<fo:table-cell padding="2pt" display-align="center" >
													<fo:block text-align="left" margin="0pt">
														<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
															<fo:inline font-weight="bold">
																<xsl:text>Fecha de alta en MUFACE:</xsl:text> 
															</fo:inline>
														</fo:block>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="3">
													<fo:block text-align="left" margin="0pt">
														<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
															<fo:inline font-style="normal"> 
																	<xsl:value-of select="concat(substring(string($datosCertificado/*[local-name()='FechaAltaMuface']),9,2),'/',substring(string($datosCertificado/*[local-name()='FechaAltaMuface']),6,2),'/',substring(string($datosCertificado/*[local-name()='FechaAltaMuface']),1,4))"/>
															</fo:inline>
														</fo:block>
													</fo:block>
												</fo:table-cell>
						  ...
						  <xsl:variable name="beneficiarios" select="$datosCertificado/*[local-name()='Beneficiarios']"/> 
							...
							<fo:block margin-top="10pt" margin-left="2pt" margin-right="2pt" text-indent="3mm" font-family="Arial,sans-serif" font-size="10pt" space-before="5mm" space-after="4mm">
							 	<fo:table table-layout="fixed" width="100%" space-after="3mm">
									<fo:table-body start-indent="0pt">
										<fo:table-row>
											<fo:table-cell padding="1pt" display-align="center" background-color="#B0C4DE">
												<fo:block>
													<fo:inline font-weight="bold" display-align="after" font-size="9pt" font-family="Arial,Helvetica,sans-serif">
														<xsl:text>Beneficiarios</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
										</fo:table-row>
							  	...
							  	<fo:table table-layout="fixed" width="100%" border-spacing="5pt" space-after="2mm">
										...
										<fo:table-column column-width="proportional-column-width(0.3)"/>
										<fo:table-body start-indent="0pt">
											<xsl:for-each select="$beneficiarios/*[local-name()='Beneficiario']"> 	 
												<fo:table-row>
													...
													<fo:table-cell padding="2pt" display-align="center" >
														<fo:block text-align="left" margin="0pt">
															<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
																<fo:inline font-style="normal">
																	<xsl:if test="*[local-name()='TipoDocumento']">
																		<xsl:text>(</xsl:text>
																		<xsl:value-of select="*[local-name()='TipoDocumento']"/>
																		<xsl:text>) </xsl:text>
														...
														<fo:block text-align="left" margin="0pt">
															<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
																<fo:inline font-style="normal">
																	...
																	<xsl:if test="*[local-name()='Apellido1']">
																		<xsl:text> </xsl:text>
																		<xsl:value-of select="*[local-name()='Apellido1']"/>
																	</xsl:if>
																	<xsl:if test="*[local-name()='Apellido2']">
																		<xsl:text> </xsl:text>
																		<xsl:value-of select="*[local-name()='Apellido2']"/>
																	</xsl:if>
																</fo:inline>
															</fo:block>
														</fo:block>
													...
													<fo:table-cell padding="2pt" display-align="center" >
														<fo:block text-align="left" margin="0pt">
															<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
																<fo:inline font-style="normal">
																	<xsl:value-of select="*[local-name()='Orden']"/>
																</fo:inline>
															</fo:block>
														</fo:block>
													</fo:table-cell>
