				...
				<fo:block border-style="solid" border-width="1px 1px 1px 1px">
												...
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															(
																<xsl:value-of
																	select="$datosTitular/*[local-name()='TipoDocumentacion']" />
															)
																<xsl:value-of
																	select="$datosTitular/*[local-name()='Documentacion']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>											
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="$datosTitular/*[local-name()='Apellido1']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="$datosTitular/*[local-name()='Apellido2']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
					...
					<xsl:if test="$datosImporteActual">   
						...
						<fo:block text-indent="3mm" margin-top="2pt" margin-left="2pt"
							...
							<fo:block margin-top="10pt" margin-left="2pt" 
								margin-right="2pt" text-indent="4mm" font-family="Arial,sans-serif"
								...
								<fo:table table-layout="fixed" width="100%" border-spacing="5pt" >
									...
									<fo:table-column column-width="proportional-column-width(1.55)" />
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosImporteActual']/*[local-name()='IMPBRUTO']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
