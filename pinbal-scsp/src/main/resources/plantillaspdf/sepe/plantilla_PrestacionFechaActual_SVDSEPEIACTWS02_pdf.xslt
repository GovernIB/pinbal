...
contains($spacechars, $c2))">
	...
	<xsl:template match="//*[local-name()='DatosEspecificos']">
		...
		<xsl:variable name="datosImporteActual" select="$datosEspecificos/*[local-name()='DatosImporteActual']"/>
		...
		<xsl:choose>
			...
			<xsl:when
				...
				<fo:block border-style="solid" border-width="1px 1px 1px 1px">
					...
					<xsl:if test="$datosImporteActual">   
						<!-- Panel Datos importe actual -->
						<fo:block text-indent="3mm" margin-top="2pt" margin-left="2pt"
							margin-right="2pt" font-family="Arial,sans-serif" font-size="10pt"
							space-before="5mm" space-after="4mm">
							<fo:table table-layout="fixed" width="100%"
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row>
										<fo:table-cell padding="3pt" display-align="center"
											...
											<fo:block>
												<fo:inline font-weight="bold" display-align="after">
													<xsl:text>Importes de las prestaciones percibidas a fecha actual</xsl:text>
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
							...
							<fo:block margin-top="10pt" margin-left="0pt" 
								margin-right="0pt" text-indent="4mm" font-family="Arial,sans-serif"
								font-size="10pt" space-before="5mm" > 
									
								<fo:table table-layout="fixed" width="100%" border-spacing="5pt" >
									<fo:table-column column-width="proportional-column-width(2.05)" />
									...
									<fo:table-body start-indent="0pt">
										<fo:table-row>
											...
											<fo:table-cell padding="0pt" display-align="before" number-columns-spanned="3">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														line-height="10pt" space-after.optimum="1pt"
														display-align="after">
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosImporteActual']/*[local-name()='TIPRES']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell padding="2pt" display-align="before" >
												<fo:block text-align="right" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosImporteActual']/*[local-name()='FXINICIOSITUACION']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell padding="2pt" display-align="before" >
												<fo:block text-align="right" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosImporteActual']/*[local-name()='FXFINSITUACION']" />
															<xsl:text>     </xsl:text>
														</fo:inline>
													</fo:block>
												</fo:block>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Base reguladora diaria (€):</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="2pt" display-align="before" >
												<fo:block text-align="right" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosImporteActual']/*[local-name()='BASEREGULA']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell padding="2pt" display-align="before" >
												<fo:block text-align="right" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-style="normal">
															<xsl:value-of select="./*[local-name()='DatosImporteActual']/*[local-name()='IMPBRUTO']" />
															<xsl:text>     </xsl:text>
														</fo:inline>
													</fo:block>
												</fo:block>
											...
											<fo:table-cell padding="2pt" display-align="before" >
												<fo:block text-align="right" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosImporteActual']/*[local-name()='IMPREASS']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell padding="2pt" display-align="before" >
												<fo:block text-align="right" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosImporteActual']/*[local-name()='IMPIRPF']" />
															<xsl:text>     </xsl:text>
														</fo:inline>
													</fo:block>
												</fo:block>
											...
											<fo:table-cell padding="2pt" display-align="before" >
												<fo:block text-align="right" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosImporteActual']/*[local-name()='IMPSEGSOC']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell> 
											
											<fo:table-cell padding="2pt" display-align="before" number-columns-spanned="2">
												<fo:block text-align="right" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														line-height="10pt" space-after.optimum="1pt"
														display-align="after">
