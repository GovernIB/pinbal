...
contains($spacechars, $c2))">
	...
	<xsl:template match="//*[local-name()='DatosEspecificos']">
		...
		<xsl:variable name="demandanteEmpleo" select="$datosEspecificos/*[local-name()='DemandanteEmpleo']"/>
									...
									<fo:table-row>
										...
										<fo:table-cell padding="0pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-style="normal">
														<xsl:choose>
															<xsl:when test="./*[local-name()='DemandanteEmpleo']/*[local-name()='Inscrito'] = 'S'">
										...
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-weight="bold">
														<xsl:if test="./*[local-name()='DemandanteEmpleo']/*[local-name()='UltimaInscripcion']">
										...
										<fo:table-cell padding="2pt" display-align="center">
											<fo:block text-align="left" margin="0pt">
												<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif" line-height="10pt" space-after.optimum="1pt" display-align="after">
													<fo:inline font-style="normal">
														<xsl:if test="./*[local-name()='DemandanteEmpleo']/*[local-name()='UltimaInscripcion'] != ''">
															<xsl:value-of select="concat(substring(string(./*[local-name()='DemandanteEmpleo']/*[local-name()='UltimaInscripcion']),7,2),'/',substring(string(./*[local-name()='DemandanteEmpleo']/*[local-name()='UltimaInscripcion']),5,2),'/',substring(string(./*[local-name()='DemandanteEmpleo']/*[local-name()='UltimaInscripcion']),1,4))"/>
														</xsl:if>															
													</fo:inline>
												</fo:block>
											</fo:block>
