...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	xmlns:str="http://www.str.com" xmlns:xs="http://www.w3.org/2001/XMLSchema"
	xmlns:functx="http://www.functx.com" exclude-result-prefixes="str functx">
...
contains($spacechars, $c2))">
		...
		<fo:root>
			<fo:layout-master-set>
				<fo:simple-page-master master-name="default-page"
					page-height="11in" page-width="9.5in" margin-top="0.2in"
					margin-right="0.9in" margin-left="0.8in">
					<fo:region-body margin-top="82" margin-bottom="120" margin-left="0.2in" />
					<fo:region-before extent="300" />
					<fo:region-after region-name="xsl-region-after"
						extent="125" />
					<fo:region-start region-name="my-left-sidebar"
                       reference-orientation="90" extent="0.2in"/>
	...
	<xsl:template name="header">
		<fo:static-content flow-name="xsl-region-before">
			<fo:block border-style="solid" border-width="1px"
				border-color="#2F4F4F">
	...
	<xsl:template name="footer">
		<fo:static-content flow-name="xsl-region-after">
			<fo:block text-align="left" margin-top="25pt">
				<fo:block font-size="9pt" font-family="Arial,Helvetica,sans-serif"
					 text-align="left" line-height="10pt" space-after.optimum="1pt" 
					 display-align="after" color="#2F4F4F">
			...
			<fo:table>
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell number-columns-spanned="2" padding="0"
							display-align="center">
							<fo:block>
								<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
									font-style="italic" text-align="justify" color="#2F4F4F">
									<fo:inline font-weight="bold">
							...
							<fo:block>
								<fo:block text-align="center">
									<fo:leader leader-pattern="rule" rule-thickness="1"
										leader-length="100%" color="#2F4F4F" />
								</fo:block>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
			...
			<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
				text-align="center" color="#2F4F4F">				
				Página 
				<fo:page-number/>
				de
	...
	<xsl:template name="left">
		<fo:static-content flow-name="my-left-sidebar">
			<fo:block text-align="end" font-size="7pt"
				font-family="Arial,Helvetica,sans-serif" line-height="8pt"
				space-after.optimum="100pt" font-weight="bold" color="#DC143C">
				<fo:inline>
	...
	<xsl:template match="//*[local-name()='DatosEspecificos']">
		...
		<xsl:variable name="datosDesempleo" select="$datosEspecificos/*[local-name()='DatosDesempleo']"/>
		...
		<fo:block margin-top="9pt" text-align="center">
			<fo:block font-size="9pt" font-family="Arial,Helvetica,sans-serif"
				line-height="10pt" space-after.optimum="1pt" display-align="after" color="#2F4F4F">				
				<fo:inline font-weight="bold">
		...
		<fo:block margin-top="2pt" text-align="center" font-family="Arial,sans-serif"
			font-size="8pt" line-height="10pt" space-after.optimum="1pt"
			display-align="after" color="#2F4F4F">
			<fo:inline font-weight="bold">
		...
		<fo:block text-align="center" font-family="Arial,sans-serif"
			font-size="8pt" line-height="10pt" space-after.optimum="1pt"
			display-align="after" color="#2F4F4F">
			<fo:inline font-weight="bold">
		...
		<xsl:choose>
			...
			<xsl:when
				test="$datosEspecificos/*[local-name()='EstadoResultado']/*[local-name()='CodigoEstado'] != '0003' ">
				<xsl:variable name="estado"
					select="$datosEspecificos/*[local-name()='EstadoResultado']" />
				<fo:block margin-top="40pt" text-align="center"
					font-family="Arial,sans-serif" font-size="10pt" line-height="10pt"
					space-after.optimum="1pt" display-align="after">
					<fo:inline font-weight="bold">
			...
			<xsl:when
				...
				<fo:block text-align="left" margin-top="25pt">
					<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
						line-height="10pt" space-after.optimum="1pt" display-align="after">
						<fo:inline font-weight="bold">
				...
				<fo:block border-style="solid" border-width="1px 1px 1px 1px">
					...
					<xsl:if test="$datosTitular">
						<!-- Panel Datos titular -->
						<fo:block text-indent="3mm" margin-top="2pt" margin-left="2pt"
							margin-right="2pt" font-family="Arial,sans-serif" font-size="10pt"
							space-before="5mm" space-after="4mm">
							<fo:table table-layout="fixed" width="100%"
								border-spacing="5pt" space-after="2mm">
								<fo:table-body start-indent="0pt">
									<fo:table-row>
						...
						<fo:block margin-top="10pt" margin-left="2pt"
								margin-right="2pt" text-indent="3mm" font-family="Arial,sans-serif"
								font-size="10pt" space-before="5mm" space-after="4mm">
							<fo:table table-layout="fixed" width="100%" border-spacing="5pt" space-after="2mm">
									...
									<fo:table-column column-width="proportional-column-width(1.05)" />
									<fo:table-column column-width="proportional-column-width(0.75)" /> 					
									<fo:table-body start-indent="0pt">
									<!-- Fila 1 Hijo -->
									<fo:table-row>  
					...
					<xsl:if test="$datosDesempleo">   
						...
						<fo:block text-indent="3mm" margin-top="2pt" margin-left="2pt"
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row>
										<fo:table-cell padding="3pt" display-align="center"
											...
											<fo:block>
												<fo:inline font-weight="bold" display-align="after">
													<xsl:text>Datos desempleo</xsl:text>
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
							...
							<fo:block margin-top="10pt" margin-left="0pt"
								margin-right="0pt" text-indent="3mm" font-family="Arial,sans-serif"
								font-size="10pt" space-before="5mm" space-after="4mm">
									...
									<fo:table-body start-indent="0pt">
										<fo:table-row>
												<fo:table-cell padding="2pt" display-align="center" >
													<fo:block text-align="left" margin="0pt">
														<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
															line-height="10pt" space-after.optimum="1pt"
															display-align="after">
															<fo:inline font-weight="bold">
												...
												<fo:table-cell padding="2pt" display-align="center"  >
													<fo:block text-align="left" margin="0pt">
														<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
															...
															<fo:inline font-style="normal">
																<xsl:value-of
																	select="./*[local-name()='DatosDesempleo']/*[local-name()='tiPres']" />
															</fo:inline>
														</fo:block>
													</fo:block>
												</fo:table-cell>
												...
												<fo:table-cell padding="2pt" display-align="center"  >
													<fo:block text-align="left" margin="0pt">
														<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
															...
															display-align="after">
															<fo:inline font-style="normal">
																<xsl:value-of select="./*[local-name()='DatosDesempleo']/*[local-name()='situacion']" />
															</fo:inline>
														</fo:block>
													</fo:block>
												</fo:table-cell>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Fecha inicio situación:</xsl:text> 
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-style="normal">
															<xsl:if test="./*[local-name()='DatosDesempleo']/*[local-name()='fxInicioSituacion'] != ''">
																<xsl:value-of select="concat(substring(string(./*[local-name()='DatosDesempleo']/*[local-name()='fxInicioSituacion']),1,2),'/',substring(string(./*[local-name()='DatosDesempleo']/*[local-name()='fxInicioSituacion']),3,2),'/',substring(string(./*[local-name()='DatosDesempleo']/*[local-name()='fxInicioSituacion']),5,8))"/>
															</xsl:if>
														</fo:inline>
													</fo:block>
												</fo:block>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Fecha fin situación:</xsl:text> 
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-style="normal">
														        <xsl:if test="./*[local-name()='DatosDesempleo']/*[local-name()='fxFinSituacion'] != ''">
																<xsl:value-of select="concat(substring(string(./*[local-name()='DatosDesempleo']/*[local-name()='fxFinSituacion']),1,2),'/',substring(string(./*[local-name()='DatosDesempleo']/*[local-name()='fxFinSituacion']),3,2),'/',substring(string(./*[local-name()='DatosDesempleo']/*[local-name()='fxFinSituacion']),5,8))"/>
																</xsl:if>
														</fo:inline>
													</fo:block>
												</fo:block>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Identificación persona física:</xsl:text>															
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosDesempleo']/*[local-name()='IPF']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Patronal del SEPE:</xsl:text>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosDesempleo']/*[local-name()='cuentaCotiza']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Días reconocidos:</xsl:text> 
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosDesempleo']/*[local-name()='diasReconocidos']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Días consumidos:</xsl:text>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosDesempleo']/*[local-name()='diasConsumidos']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosDesempleo']/*[local-name()='baseRegula']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Base de contingencias comunes:</xsl:text>   															
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosDesempleo']/*[local-name()='cotizacion']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Indicador retención judicial:</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosDesempleo']/*[local-name()='indRetJudicial']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Indicador embargo:</xsl:text>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosDesempleo']/*[local-name()='indEmbargo']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Indicador cobro indebido:</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="2pt" display-align="center" number-columns-spanned="3">
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosDesempleo']/*[local-name()='indCobroIndebido']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
