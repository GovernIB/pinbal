											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Indicador de Situacion:</xsl:text>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														<fo:inline font-style="normal">
															<xsl:value-of
																select="./*[local-name()='DatosDesempleo']/*[local-name()='indSituacion']" />
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:table-cell>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Dias Consumidos:</xsl:text>
											...
											<fo:table-cell padding="2pt" display-align="center" >
												<fo:block text-align="left" margin="0pt">
													<fo:block font-size="8pt" font-family="Arial,Helvetica,sans-serif"
														...
														display-align="after">
														<fo:inline font-weight="bold">
															<xsl:text>Patronal del SPEE:</xsl:text>
