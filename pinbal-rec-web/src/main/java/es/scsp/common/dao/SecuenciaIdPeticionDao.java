...
@Component
public class SecuenciaIdPeticionDao extends BaseDao implements Runnable {
	private static final Log log = LogFactory
			.getLog(SecuenciaIdPeticionDao.class);

	@Autowired
	private DataSource datasource;

	public static void main(String[] args) {
		SecuenciaIdPeticionDao sc = new SecuenciaIdPeticionDao();
