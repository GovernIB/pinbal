...
import es.caib.pinbal.logic.intf.helper.DocumentIdentitatHelper;
...
public class RecobrimentV2Helper implements ApplicationContextAware, MessageSourceAware {
	...
	public void validateDadesComunes(DadesComunes dadesComunes, String serveiCodi, BindException errors) {
		...
		Procediment procediment = procedimentRepository.findByEntitatAndCodi(entitat, dadesComunes.getProcedimentCodi());
		if (procediment == null) {
...
//		validateCampLength(funcionariNom, "dadesComunes.funcionari.nom", 122, errors);
	...
	private String determinarUnitatTramitadora(ServeiConfig serveiConfig, Procediment procediment) {
