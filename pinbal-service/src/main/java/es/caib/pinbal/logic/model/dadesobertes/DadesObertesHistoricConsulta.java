package es.caib.pinbal.logic.model.dadesobertes;
...
public class DadesObertesHistoricConsulta {
    ...
    private DadesObertesRespostaConsulta.DadesObertesConsultaTipus tipus;

    @Column(name = "resultat", length = 16)
    @Enumerated(EnumType.STRING)
    private DadesObertesRespostaConsulta.DadesObertesConsultaResultat resultat;
