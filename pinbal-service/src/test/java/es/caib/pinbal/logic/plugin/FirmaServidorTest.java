...
public class FirmaServidorTest {
    ...
    public void setup() {
        ...
        when(configHelper.getConfig(Mockito.eq("es.caib.pinbal.plugin.firmaservidor.class"))).thenReturn("es.caib.pinbal.plugin.firmaservidor.FirmaSimpleServidorPluginPortafib");
