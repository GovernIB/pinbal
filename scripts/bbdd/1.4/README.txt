...
Si la versió anterior és la 1.0.x, executar els següents scripts en aquest ordre:
	- pinbal_update_1.0.sql
	- pinbal_update_1.1.sql
	- pinbal_update_1.2.sql
	- pinbal_update_1.3.sql
Si la versió anterior és la 1.1.x, executar els següents scripts en aquest ordre:
	- pinbal_update_1.1.sql
	- pinbal_update_1.2.sql
	- pinbal_update_1.3.sql
Si la versió anterior és la 1.2.x, executar els següents scripts en aquest ordre:
	- pinbal_update_1.2.sql
	- pinbal_update_1.3.sql
Si la versió anterior és la 1.3.x, executar els següents scripts en aquest ordre:
	- pinbal_update_1.3.sql
