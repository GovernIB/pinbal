...
--------------------------------------------------------
  ...
  ALTER TABLE "CORE_CLAVE_PRIVADA" ADD CONSTRAINT "CLAVEPRIVADA_ORG" FOREIGN KEY ("ORGANISMO")
	  REFERENCES "ORGANISMO_CESIONARIO" ("ID") ENABLE;
...
-------------------------------------------------------- 
   ...
   COMMENT ON TABLE "CORE_TIPO_MENSAJE"  IS 'Tabla maestra que almacena los diferentes tipos de mensajes que pueden ser intercambiados a lo largo de un ciclo de comunicación SCSP. Estos valores serán: -	Peticion -	Respuesta -	SolicitudRespuesta -	ConfirmacionPeticion -	Fault';
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   COMMENT ON COLUMN "CORE_CACHE_CERTIFICADOS"."TIEMPOCOMPROBACION" IS 'Fecha en la que se realizo el proceso de validación del certificado por última vez'; 
...
--------------------------------------------------------
   ...
   COMMENT ON COLUMN "CORE_MODULO"."ACTIVOENTRADA" IS 'Valor que indica si el módulo esta activo en la emisión de mensajes. Puede tomar valor 1 (Activo) | 0 (Inactivo)';
   COMMENT ON COLUMN "CORE_MODULO"."ACTIVOSALIDA" IS 'Valor que indica si el módulo esta activo en la recepción de mensajes. Puede tomar valor 1 (Activo) | 0 (Inactivo)';
...
--------------------------------------------------------
   ...
   COMMENT ON COLUMN "CORE_MODULO_CONFIGURACION"."ACTIVOENTRADA" IS 'Valor que indica si el módulo esta activo en la emisión de mensajes. Puede tomar valor 1 (Activo) | 0 (Inactivo)';
   COMMENT ON COLUMN "CORE_MODULO_CONFIGURACION"."ACTIVOSALIDA" IS 'Valor que indica si el módulo esta activo en la recepción de mensajes. Puede tomar valor 1 (Activo) | 0 (Inactivo)';
...
-------------------------------------------------------- 
   ...
   COMMENT ON COLUMN "CORE_SECUENCIA_IDPETICION"."FECHAGENERACION" IS 'Fecha en la que se registrá  el secuencial';
...
--------------------------------------------------------
   ...
   COMMENT ON COLUMN "CORE_TOKEN_DATA"."TIPOMENSAJE" IS 'Tipo de mensaje almacenado, podrá ser : -Peticion -Respuesta -SolicitudRespuesta -ConfirmacionPeticion -Fault';
