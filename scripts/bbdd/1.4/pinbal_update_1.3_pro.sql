...
/* UpdateRequirente-3.5.1a3.5.2 (PRO) */
...
UPDATE CORE_SERVICIO SET URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/DGSeguros.ConsultaMediadores', URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/DGSeguros.ConsultaMediadores' WHERE CODCERTIFICADO ='DGSFP0001';
UPDATE CORE_SERVICIO SET URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/DGSeguros.ConsultaAseguradoras', URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/DGSeguros.ConsultaAseguradoras' WHERE CODCERTIFICADO ='DGSFP0002';
UPDATE CORE_SERVICIO SET URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/DGSeguros.ConsultaFondos', URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/DGSeguros.ConsultaFondos' WHERE CODCERTIFICADO ='DGSFP0003';
UPDATE CORE_SERVICIO SET URLSINCRONA=null, URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/DGSeguros.ConsultaSolvencia' WHERE CODCERTIFICADO ='DGSFP0005';
UPDATE CORE_SERVICIO SET URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/Notarios.ConsultaAdministradores'   WHERE CODCERTIFICADO ='SVDNOTSUBADMWS01';
UPDATE CORE_SERVICIO SET URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/Notarios.ConsultaSubsistencia'   WHERE CODCERTIFICADO ='SVDNOTSUBWS01';
UPDATE CORE_SERVICIO SET URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/Notarios.ConsultaCopiaSimple'   WHERE CODCERTIFICADO ='SVDNOTCOPSIMWS01';
UPDATE CORE_SERVICIO SET URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/Notarios.ConsultaNotarios'   WHERE CODCERTIFICADO ='SVDNOTLISTWS01';
ALTER TABLE  CORE_SERVICIO  ADD PLANTILLADETALLESERVICIO VARCHAR2(512)   NULL;

/* UpdateRequirente-3.5.2a3.5.3 (PRO) */
...
update CORE_SERVICIO set ACTIONSINCRONA='peticionSincrona', URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/TGSS.CorrientePago',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/TGSS.CorrientePago.Asincrona'  where CODCERTIFICADO='Q2827003ATGSS001';
update CORE_SERVICIO set ACTIONSINCRONA='peticionSincrona', URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/TGSS.AltaEnFecha'   where CODCERTIFICADO='Q2827003ATGSS006';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/IMSERSO.ConsultaDatosDependencia',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/IMSERSO.ConsultaDatosDependencia.Asincrona'  where CODCERTIFICADO='SVDCDEPENWS01';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/INSS.ConsultaPrestaciones'  where CODCERTIFICADO='Q2827002CINSS001';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/Navarra.ConsultaIAE',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/Navarra.ConsultaIAE.Asincrona'  where CODCERTIFICADO='HTNIAE';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/DGSeguros.ConsultaMediadores',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/DGSeguros.ConsultaMediadores.Asincrona'  where CODCERTIFICADO='DGSFP0001';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/DGSeguros.ConsultaAseguradoras',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/DGSeguros.ConsultaAseguradoras.Asincrona'  where CODCERTIFICADO='DGSFP0002';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/DGSeguros.ConsultaFondos',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/DGSeguros.ConsultaFondos.Asincrona'  where CODCERTIFICADO='DGSFP0003';
update CORE_SERVICIO set URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/DGSeguros.ConsultaSolvencia.Asincrona'  where CODCERTIFICADO='DGSFP0005';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/MAEC.ConsultaLegalizacionFirmas',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/MAEC.ConsultaLegalizacionFirmas.Asincrona'  where CODCERTIFICADO='SVDMAECWS01';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/Notarios.ConsultaNotarios'  where CODCERTIFICADO='SVDNOTLISTWS01';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/Notarios.ConsultaSubsistencia'  where CODCERTIFICADO='SVDNOTSUBWS01';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/Notarios.ConsultaCopiaSimple'  where CODCERTIFICADO='SVDNOTCOPSIMWS01';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/Notarios.ConsultaAdministradores'  where CODCERTIFICADO='SVDNOTSUBADMWS01';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/MUFACE.CertificadoAbonos',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/MUFACE.CertificadoAbonos.Asincrona'  where CODCERTIFICADO='SVDMUFABSWS01';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/MUFACE.CertificadoAfiliacion',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/MUFACE.CertificadoAfiliacion.Asincrona'  where CODCERTIFICADO='SVDMUFAFIWS01';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/MUFACE.CertificadoPrestacionesRecibidas',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/MUFACE.CertificadoPrestacionesRecibidas.Asincrona'  where CODCERTIFICADO='SVDMUFPRESTAWS01';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/PaisVasco.ConsultaIAE',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/PaisVasco.ConsultaIAE.Asincrona'  where CODCERTIFICADO='SVDPVIAEWS01';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/Extranjeria.ConsultaResidenciaLegal',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/Extranjeria.ConsultaResidenciaLegal.Asincrona'  where CODCERTIFICADO='SVDRESLEGEXWS01';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/RegistroCivil.ConsultaNacimiento',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/RegistroCivil.ConsultaNacimiento.Asincrona'  where CODCERTIFICADO='SVDSCCNWS01';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/RegistroCivil.ConsultaMatrimonio',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/RegistroCivil.ConsultaMatrimonio.Asincrona'  where CODCERTIFICADO='SVDSCCMWS01';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/RegistroCivil.ConsultaDefuncion',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/RegistroCivil.ConsultaDefuncion.Asincrona'  where CODCERTIFICADO='SVDSCCDWS01';
UPDATE CORE_SERVICIO SET URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/SEPE.CertificadoDatosDesempleo.Asincrona'  where CODCERTIFICADO='SVDSEPESITWS02';
UPDATE CORE_SERVICIO SET URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/SEPE.CertificadoImportesActuales.Asincrona'  where CODCERTIFICADO='SVDSEPEIACTWS02';
UPDATE CORE_SERVICIO SET URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/SEPE.CertificadoImportesPeriodos.Asincrona'  where CODCERTIFICADO='SVDSEPEIPERWS02'; 
UPDATE CORE_SERVICIO SET ACTIONSINCRONA='peticionSincrona', URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/SEPE.InscritoDemandanteEmpleo',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/SEPE.InscritoDemandanteEmpleo.Asincrona'  where CODCERTIFICADO='SVDSEPEDEMWS01';
UPDATE CORE_SERVICIO SET ACTIONSINCRONA='peticionSincrona', URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/SEPE.InscritoDemandanteEmpleoFechaConcreta',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/SEPE.InscritoDemandanteEmpleoFechaConcreta.Asincrona'  where CODCERTIFICADO='SVDSEPEDEMFECHAWS01';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/INE.VerificacionResidenciaFecha',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/INE.VerificacionResidenciaFecha.Asincrona'  where CODCERTIFICADO='SVDREXTFECHAWS01';
update CORE_SERVICIO set URLSINCRONA='https://intermediacion.redsara.es/servicios/SVD/INE.VerificacionAmbitoResidencia',URLASINCRONA='https://intermediacion.redsara.es/servicios/SVD/INE.VerificacionAmbitoResidencia.Asincrona'  where CODCERTIFICADO='SVDRWS01';
