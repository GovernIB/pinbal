...
Si la versió anterior és la 1.0: executar pinbal_update_1.0.sql i pinbal_update_1.1.sql en aquest ordre.
Si la versió anterior és la 1.1: executar pinbal_update_1.1.sql.
