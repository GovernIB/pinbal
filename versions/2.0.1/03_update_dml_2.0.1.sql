...
INSERT INTO pbl_config (key, value, description_key, group_code, position, source_property, type_code) VALUES ('es.caib.pinbal.plugin.dades.usuari.pluginsib.userinformation.ldap.security_credentials', '', 'propietat.dades.usuari.pluginsib.userinformation.ldap.security_credentials', 'USUARIS', '3', 'FILE', 'PASSWORD');
...
INSERT INTO pbl_config (key, value, description_key, group_code, position, source_property, type_code) VALUES ('es.caib.pinbal.plugin.dades.usuari.pluginsib.userinformation.keycloak.password_secret', '', 'propietat.dades.usuari.pluginsib.userinformation.keycloak.password_secret', 'USUARIS', '21', 'FILE', 'PASSWORD');
