 ...
 */
public class ServeiGrupValidator implements ConstraintValidator<ServeiRegla, ServeiReglaCommand> {
	...
	public boolean isValid(
		...
		if (command.getNom() != null) {
			ServeiCampGrupDto repetit = serveiService.serveiCampGrupFindByNom(command.getServeiId(), command.getNom());
