...
jQuery.tableDnD = {
    ...
    processMouseup: function() {
        ...
        console.log('tDnD: Drop');
        console.log('tDnD: Drop. Order (org=' + this.originalOrder + ',dest=' + this.currentOrder() + ')? ' + (this.originalOrder !== this.currentOrder()));
        console.log('tDnD: Drop. Method? ' + config.onDrop);
        config.onDrop
            && this.originalOrder !== this.currentOrder()
