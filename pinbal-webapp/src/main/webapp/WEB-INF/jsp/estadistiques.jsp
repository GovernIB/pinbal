...
<body>
<div class="text-right" data-toggle="titol-check" data-titol-check-value="${historic}" data-titol-check-session-name="estadistiques.admin" data-titol-check-callback="checkCallback" data-titol-check-label="<spring:message code="comu.historic"/>"></div>
