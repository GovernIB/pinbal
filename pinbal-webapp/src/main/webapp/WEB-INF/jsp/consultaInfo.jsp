					...
					<fieldset>
						<legend><spring:message code="consulta.form.dades.generiques"/>						
							<c:if test="${consulta.hiHaPeticio}">
								...
								<a class="btn btn-default pull-right" style="top: -4px; position: relative;" href="<c:url value="/modal/consulta/${consulta.id}/xmlPeticio"/>" onclick="${initModalXml}">
				...
				<div class="well well-sm">
					<fieldset>
						<legend><spring:message code="consulta.info.resposta.dades"/>
							<c:set var="initModalXml">initModalXml(this);return false</c:set>
							<a class="btn btn-default pull-right" style="top: -4px; position: relative;" href="<c:url value="/modal/consulta/${consulta.id}/xmlResposta"/>" onclick="${initModalXml}">
								<i class="fas fa-info-circle"></i> <spring:message code="consulta.info.veure.xml"/>
							</a>
						</legend>
						<div class="clearfix legend-margin-bottom"></div>
							...
							<div class="col-md-12">
								...
								<div class="dropdown pull-right">
									...
									<ul class="dropdown-menu">
										...
										<li>
											<a href="../consulta/${consulta.id}/justificantReintentar?info=true" class="justificant-reintentar">
