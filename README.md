...
- <a name="v_estable"></a> Versió Estable: __pinbal-1.4.41__ (tag [PINBAL 1.4.43](https://github.com/GovernIB/pinbal/releases/tag/v1.4.43.rc5))
...
- Versió actual del client REST: __1.4.44__ ([pinbal-client-1.4.44.jar](https://github.com/GovernIB/maven/raw/gh-pages/maven/es/caib/pinbal/pinbal-client/1.4.44/pinbal-client-1.4.44.jar))  
    ```
    <dependency>  
