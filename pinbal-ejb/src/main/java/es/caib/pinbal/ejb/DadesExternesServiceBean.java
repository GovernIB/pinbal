...
@Primary
@Stateless
public class DadesExternesServiceBean extends AbstractService<es.caib.pinbal.logic.intf.service.DadesExternesService> implements es.caib.pinbal.logic.intf.service.DadesExternesService {
