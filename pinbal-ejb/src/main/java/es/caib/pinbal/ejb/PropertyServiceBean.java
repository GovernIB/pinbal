...
@Primary
@Stateless
public class PropertyServiceBean extends AbstractService<es.caib.pinbal.logic.intf.service.PropertyService> implements es.caib.pinbal.logic.intf.service.PropertyService {
