...
@Primary
@Stateless
public class IntegracioAccioServiceBean extends AbstractService<es.caib.pinbal.logic.intf.service.IntegracioAccioService> implements es.caib.pinbal.logic.intf.service.IntegracioAccioService {
