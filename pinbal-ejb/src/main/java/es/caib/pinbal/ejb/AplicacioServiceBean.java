...
@Primary
@Stateless
public class AplicacioServiceBean extends AbstractService<es.caib.pinbal.logic.intf.service.AplicacioService> implements es.caib.pinbal.logic.intf.service.AplicacioService {
