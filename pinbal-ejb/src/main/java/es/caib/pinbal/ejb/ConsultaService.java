...
@Stateless
@Primary
public class ConsultaService extends AbstractService<es.caib.pinbal.logic.intf.service.ConsultaService> implements es.caib.pinbal.logic.intf.service.ConsultaService {
