...
@Primary
@Stateless
public class ScspService extends AbstractService<es.caib.pinbal.logic.intf.service.ScspService> implements es.caib.pinbal.logic.intf.service.ScspService {
